...
type MsgVpnRestDeliveryPointRestConsumersResponse struct {
	Collections *[]MsgVpnRestDeliveryPointRestConsumerCollections `json:"collections,omitempty"`
...
func (o *MsgVpnRestDeliveryPointRestConsumersResponse) GetCollections() []MsgVpnRestDeliveryPointRestConsumerCollections {
	if o == nil || o.Collections == nil {
		var ret []MsgVpnRestDeliveryPointRestConsumerCollections
		return ret
	}
...
// SetCollections gets a reference to the given []MsgVpnRestDeliveryPointRestConsumerCollections and assigns it to the Collections field.
