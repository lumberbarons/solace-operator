...
// MsgVpnTopicEndpointPriorityResponse struct for MsgVpnTopicEndpointPriorityResponse
type MsgVpnTopicEndpointPriorityResponse struct {
...
func NewMsgVpnTopicEndpointPriorityResponse(meta SempMeta) *MsgVpnTopicEndpointPriorityResponse {
	this := MsgVpnTopicEndpointPriorityResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnTopicEndpointPriorityResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointPriorityResponse struct {
	value *MsgVpnTopicEndpointPriorityResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointPriorityResponse) Get() *MsgVpnTopicEndpointPriorityResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointPriorityResponse) Set(val *MsgVpnTopicEndpointPriorityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointPriorityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointPriorityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointPriorityResponse(val *MsgVpnTopicEndpointPriorityResponse) *NullableMsgVpnTopicEndpointPriorityResponse {
	return &NullableMsgVpnTopicEndpointPriorityResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointPriorityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointPriorityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
