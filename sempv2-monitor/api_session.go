...
/*
SessionApiService Get a Session object.
 ...
 * @param optional nil or *SessionApiGetSessionOpts - Optional Parameters:
...
type SessionApiGetSessionOpts struct {
	Select_ optional.Interface
}

func (a *SessionApiService) GetSession(ctx context.Context, sessionUsername string, sessionId string, localVarOptionals *SessionApiGetSessionOpts) (SessionResponse, *http.Response, error) {
	var (
...
/*
SessionApiService Get a list of Session objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SessionApiGetSessionsOpts - Optional Parameters:
...
type SessionApiGetSessionsOpts struct {
...
func (a *SessionApiService) GetSessions(ctx context.Context, localVarOptionals *SessionApiGetSessionsOpts) (SessionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
