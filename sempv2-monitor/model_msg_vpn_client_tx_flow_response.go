...
// MsgVpnClientTxFlowResponse struct for MsgVpnClientTxFlowResponse
type MsgVpnClientTxFlowResponse struct {
...
func NewMsgVpnClientTxFlowResponse(meta SempMeta) *MsgVpnClientTxFlowResponse {
	this := MsgVpnClientTxFlowResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnClientTxFlowResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientTxFlowResponse struct {
	value *MsgVpnClientTxFlowResponse
	isSet bool
}

func (v NullableMsgVpnClientTxFlowResponse) Get() *MsgVpnClientTxFlowResponse {
	return v.value
}

func (v *NullableMsgVpnClientTxFlowResponse) Set(val *MsgVpnClientTxFlowResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientTxFlowResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientTxFlowResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientTxFlowResponse(val *MsgVpnClientTxFlowResponse) *NullableMsgVpnClientTxFlowResponse {
	return &NullableMsgVpnClientTxFlowResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientTxFlowResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientTxFlowResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
