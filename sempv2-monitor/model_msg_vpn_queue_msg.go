...
// MsgVpnQueueMsg struct for MsgVpnQueueMsg
type MsgVpnQueueMsg struct {
...
func (o MsgVpnQueueMsg) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueMsg struct {
	value *MsgVpnQueueMsg
	isSet bool
}

func (v NullableMsgVpnQueueMsg) Get() *MsgVpnQueueMsg {
	return v.value
}

func (v *NullableMsgVpnQueueMsg) Set(val *MsgVpnQueueMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueMsg(val *MsgVpnQueueMsg) *NullableMsgVpnQueueMsg {
	return &NullableMsgVpnQueueMsg{value: val, isSet: true}
}

func (v NullableMsgVpnQueueMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
