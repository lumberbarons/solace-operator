...
// MsgVpnClientTransactedSessionResponse struct for MsgVpnClientTransactedSessionResponse
type MsgVpnClientTransactedSessionResponse struct {
...
func NewMsgVpnClientTransactedSessionResponse(meta SempMeta) *MsgVpnClientTransactedSessionResponse {
	this := MsgVpnClientTransactedSessionResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnClientTransactedSessionResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientTransactedSessionResponse struct {
	value *MsgVpnClientTransactedSessionResponse
	isSet bool
}

func (v NullableMsgVpnClientTransactedSessionResponse) Get() *MsgVpnClientTransactedSessionResponse {
	return v.value
}

func (v *NullableMsgVpnClientTransactedSessionResponse) Set(val *MsgVpnClientTransactedSessionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientTransactedSessionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientTransactedSessionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientTransactedSessionResponse(val *MsgVpnClientTransactedSessionResponse) *NullableMsgVpnClientTransactedSessionResponse {
	return &NullableMsgVpnClientTransactedSessionResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientTransactedSessionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientTransactedSessionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
