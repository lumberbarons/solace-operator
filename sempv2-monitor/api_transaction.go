...
/*
TransactionApiService Get a Replicated Local Transaction or XA Transaction object.
 ...
 * @param optional nil or *TransactionApiGetMsgVpnTransactionOpts - Optional Parameters:
...
type TransactionApiGetMsgVpnTransactionOpts struct {
	Select_ optional.Interface
}

func (a *TransactionApiService) GetMsgVpnTransaction(ctx context.Context, msgVpnName string, xid string, localVarOptionals *TransactionApiGetMsgVpnTransactionOpts) (MsgVpnTransactionResponse, *http.Response, error) {
	var (
...
/*
TransactionApiService Get a Transaction Consumer Message object.
 ...
 * @param optional nil or *TransactionApiGetMsgVpnTransactionConsumerMsgOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnTransactionConsumerMsgResponse
*/

type TransactionApiGetMsgVpnTransactionConsumerMsgOpts struct {
	Select_ optional.Interface
}

func (a *TransactionApiService) GetMsgVpnTransactionConsumerMsg(ctx context.Context, msgVpnName string, xid string, msgId string, localVarOptionals *TransactionApiGetMsgVpnTransactionConsumerMsgOpts) (MsgVpnTransactionConsumerMsgResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TransactionApiService Get a list of Transaction Consumer Message objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param xid The identifier (ID) of the Transaction.
 * @param optional nil or *TransactionApiGetMsgVpnTransactionConsumerMsgsOpts - Optional Parameters:
...
type TransactionApiGetMsgVpnTransactionConsumerMsgsOpts struct {
...
func (a *TransactionApiService) GetMsgVpnTransactionConsumerMsgs(ctx context.Context, msgVpnName string, xid string, localVarOptionals *TransactionApiGetMsgVpnTransactionConsumerMsgsOpts) (MsgVpnTransactionConsumerMsgsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TransactionApiService Get a Transaction Publisher Message object.
 ...
 * @param xid The identifier (ID) of the Transaction.
 * @param msgId The identifier (ID) of the Message.
 * @param optional nil or *TransactionApiGetMsgVpnTransactionPublisherMsgOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnTransactionPublisherMsgResponse
*/

type TransactionApiGetMsgVpnTransactionPublisherMsgOpts struct {
	Select_ optional.Interface
}

func (a *TransactionApiService) GetMsgVpnTransactionPublisherMsg(ctx context.Context, msgVpnName string, xid string, msgId string, localVarOptionals *TransactionApiGetMsgVpnTransactionPublisherMsgOpts) (MsgVpnTransactionPublisherMsgResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TransactionApiService Get a list of Transaction Publisher Message objects.
Get a list of Transaction Publisher Message objects.  A Transaction Publisher Message is a message that will be published as part of this Transaction once the Transaction is committed.   Attribute|Identifying|Deprecated :---|:---:|:---: msgId|x| msgVpnName|x| xid|x|    A SEMP client authorized with a minimum access scope/level of \&quot;vpn/read-only\&quot; is required to perform this operation.  This has been available since 2.12.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param xid The identifier (ID) of the Transaction.
 * @param optional nil or *TransactionApiGetMsgVpnTransactionPublisherMsgsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type TransactionApiGetMsgVpnTransactionPublisherMsgsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *TransactionApiService) GetMsgVpnTransactionPublisherMsgs(ctx context.Context, msgVpnName string, xid string, localVarOptionals *TransactionApiGetMsgVpnTransactionPublisherMsgsOpts) (MsgVpnTransactionPublisherMsgsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TransactionApiService Get a list of Replicated Local Transaction or XA Transaction objects.
Get a list of Replicated Local Transaction or XA Transaction objects.  Transactions can be used to group a set of Guaranteed messages to be published or consumed or both as an atomic unit of work.   Attribute|Identifying|Deprecated :---|:---:|:---: msgVpnName|x| xid|x|    A SEMP client authorized with a minimum access scope/level of \&quot;vpn/read-only\&quot; is required to perform this operation.  This has been available since 2.12.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *TransactionApiGetMsgVpnTransactionsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type TransactionApiGetMsgVpnTransactionsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *TransactionApiService) GetMsgVpnTransactions(ctx context.Context, msgVpnName string, localVarOptionals *TransactionApiGetMsgVpnTransactionsOpts) (MsgVpnTransactionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
