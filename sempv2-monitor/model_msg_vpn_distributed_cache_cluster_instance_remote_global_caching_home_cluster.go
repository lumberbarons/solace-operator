...
// MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster struct for MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster
type MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster struct {
	// The name of the Distributed Cache.
	CacheName *string `json:"cacheName,omitempty"`
	// The number of cache requests forwarded to the remote Home Cache Cluster.
	CacheRequestForwardedCount *int64 `json:"cacheRequestForwardedCount,omitempty"`
	// The number of cache requests received from the remote Home Cache Cluster.
	CacheRequestRxCount *int64 `json:"cacheRequestRxCount,omitempty"`
	// The name of the Cache Cluster.
	ClusterName *string `json:"clusterName,omitempty"`
	// The number of heartbeat messages received from the remote Home Cache Cluster.
	HeartbeatRxCount *int64 `json:"heartbeatRxCount,omitempty"`
	// Indicates whether the operational state of the heartbeat with the remote Home Cache Cluster is up.
	HeartbeatUp *bool `json:"heartbeatUp,omitempty"`
...
func NewMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster() *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster {
	this := MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster{}
	return &this
}
...
// GetCacheRequestForwardedCount returns the CacheRequestForwardedCount field value if set, zero value otherwise.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetCacheRequestForwardedCount() int64 {
	if o == nil || o.CacheRequestForwardedCount == nil {
		var ret int64
		return ret
	}
	return *o.CacheRequestForwardedCount
}

// GetCacheRequestForwardedCountOk returns a tuple with the CacheRequestForwardedCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetCacheRequestForwardedCountOk() (*int64, bool) {
	if o == nil || o.CacheRequestForwardedCount == nil {
		return nil, false
	}
	return o.CacheRequestForwardedCount, true
}
...
// SetCacheRequestForwardedCount gets a reference to the given int64 and assigns it to the CacheRequestForwardedCount field.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) SetCacheRequestForwardedCount(v int64) {
	o.CacheRequestForwardedCount = &v
}

// GetCacheRequestRxCount returns the CacheRequestRxCount field value if set, zero value otherwise.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetCacheRequestRxCount() int64 {
	if o == nil || o.CacheRequestRxCount == nil {
		var ret int64
		return ret
	}
	return *o.CacheRequestRxCount
}

// GetCacheRequestRxCountOk returns a tuple with the CacheRequestRxCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetCacheRequestRxCountOk() (*int64, bool) {
	if o == nil || o.CacheRequestRxCount == nil {
		return nil, false
	}
	return o.CacheRequestRxCount, true
}
...
// SetCacheRequestRxCount gets a reference to the given int64 and assigns it to the CacheRequestRxCount field.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) SetCacheRequestRxCount(v int64) {
	o.CacheRequestRxCount = &v
}
...
// GetHeartbeatRxCount returns the HeartbeatRxCount field value if set, zero value otherwise.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetHeartbeatRxCount() int64 {
	if o == nil || o.HeartbeatRxCount == nil {
		var ret int64
		return ret
	}
	return *o.HeartbeatRxCount
}

// GetHeartbeatRxCountOk returns a tuple with the HeartbeatRxCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetHeartbeatRxCountOk() (*int64, bool) {
	if o == nil || o.HeartbeatRxCount == nil {
		return nil, false
	}
	return o.HeartbeatRxCount, true
}
...
// SetHeartbeatRxCount gets a reference to the given int64 and assigns it to the HeartbeatRxCount field.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) SetHeartbeatRxCount(v int64) {
	o.HeartbeatRxCount = &v
}

// GetHeartbeatUp returns the HeartbeatUp field value if set, zero value otherwise.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetHeartbeatUp() bool {
	if o == nil || o.HeartbeatUp == nil {
		var ret bool
		return ret
	}
	return *o.HeartbeatUp
}

// GetHeartbeatUpOk returns a tuple with the HeartbeatUp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) GetHeartbeatUpOk() (*bool, bool) {
	if o == nil || o.HeartbeatUp == nil {
		return nil, false
	}
	return o.HeartbeatUp, true
}
...
// SetHeartbeatUp gets a reference to the given bool and assigns it to the HeartbeatUp field.
...
func (o MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.CacheName != nil {
		toSerialize["cacheName"] = o.CacheName
	}
	if o.CacheRequestForwardedCount != nil {
		toSerialize["cacheRequestForwardedCount"] = o.CacheRequestForwardedCount
	}
	if o.CacheRequestRxCount != nil {
		toSerialize["cacheRequestRxCount"] = o.CacheRequestRxCount
	}
	if o.ClusterName != nil {
		toSerialize["clusterName"] = o.ClusterName
	}
	if o.HeartbeatRxCount != nil {
		toSerialize["heartbeatRxCount"] = o.HeartbeatRxCount
	}
	if o.HeartbeatUp != nil {
		toSerialize["heartbeatUp"] = o.HeartbeatUp
	}
...
type NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster struct {
	value *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster
	isSet bool
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) Get() *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster {
	return v.value
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) Set(val *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster(val *MsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) *NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster {
	return &NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteGlobalCachingHomeCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
