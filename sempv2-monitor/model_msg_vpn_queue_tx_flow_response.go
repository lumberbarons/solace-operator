...
// MsgVpnQueueTxFlowResponse struct for MsgVpnQueueTxFlowResponse
type MsgVpnQueueTxFlowResponse struct {
...
func NewMsgVpnQueueTxFlowResponse(meta SempMeta) *MsgVpnQueueTxFlowResponse {
	this := MsgVpnQueueTxFlowResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnQueueTxFlowResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueTxFlowResponse struct {
	value *MsgVpnQueueTxFlowResponse
	isSet bool
}

func (v NullableMsgVpnQueueTxFlowResponse) Get() *MsgVpnQueueTxFlowResponse {
	return v.value
}

func (v *NullableMsgVpnQueueTxFlowResponse) Set(val *MsgVpnQueueTxFlowResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueTxFlowResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueTxFlowResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueTxFlowResponse(val *MsgVpnQueueTxFlowResponse) *NullableMsgVpnQueueTxFlowResponse {
	return &NullableMsgVpnQueueTxFlowResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueueTxFlowResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueTxFlowResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
