...
// MsgVpnClientSubscription struct for MsgVpnClientSubscription
type MsgVpnClientSubscription struct {
...
func (o MsgVpnClientSubscription) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientSubscription struct {
	value *MsgVpnClientSubscription
	isSet bool
}

func (v NullableMsgVpnClientSubscription) Get() *MsgVpnClientSubscription {
	return v.value
}

func (v *NullableMsgVpnClientSubscription) Set(val *MsgVpnClientSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientSubscription(val *MsgVpnClientSubscription) *NullableMsgVpnClientSubscription {
	return &NullableMsgVpnClientSubscription{value: val, isSet: true}
}

func (v NullableMsgVpnClientSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
