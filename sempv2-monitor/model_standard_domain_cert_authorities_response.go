...
// StandardDomainCertAuthoritiesResponse struct for StandardDomainCertAuthoritiesResponse
type StandardDomainCertAuthoritiesResponse struct {
	Collections *[]map[string]interface{}           `json:"collections,omitempty"`
	Data        *[]StandardDomainCertAuthority      `json:"data,omitempty"`
	Links       *[]StandardDomainCertAuthorityLinks `json:"links,omitempty"`
...
func NewStandardDomainCertAuthoritiesResponse(meta SempMeta) *StandardDomainCertAuthoritiesResponse {
	this := StandardDomainCertAuthoritiesResponse{}
	this.Meta = meta
	return &this
}
...
func (o *StandardDomainCertAuthoritiesResponse) GetData() []StandardDomainCertAuthority {
	if o == nil || o.Data == nil {
		var ret []StandardDomainCertAuthority
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []StandardDomainCertAuthority and assigns it to the Data field.
...
func (o *StandardDomainCertAuthoritiesResponse) GetLinks() []StandardDomainCertAuthorityLinks {
	if o == nil || o.Links == nil {
		var ret []StandardDomainCertAuthorityLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []StandardDomainCertAuthorityLinks and assigns it to the Links field.
...
func (o StandardDomainCertAuthoritiesResponse) MarshalJSON() ([]byte, error) {
...
type NullableStandardDomainCertAuthoritiesResponse struct {
	value *StandardDomainCertAuthoritiesResponse
	isSet bool
}

func (v NullableStandardDomainCertAuthoritiesResponse) Get() *StandardDomainCertAuthoritiesResponse {
	return v.value
}

func (v *NullableStandardDomainCertAuthoritiesResponse) Set(val *StandardDomainCertAuthoritiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStandardDomainCertAuthoritiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStandardDomainCertAuthoritiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStandardDomainCertAuthoritiesResponse(val *StandardDomainCertAuthoritiesResponse) *NullableStandardDomainCertAuthoritiesResponse {
	return &NullableStandardDomainCertAuthoritiesResponse{value: val, isSet: true}
}

func (v NullableStandardDomainCertAuthoritiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStandardDomainCertAuthoritiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
