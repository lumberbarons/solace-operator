...
// MsgVpnConfigSyncRemoteNode struct for MsgVpnConfigSyncRemoteNode
type MsgVpnConfigSyncRemoteNode struct {
	// The amount of time in seconds since the last message was received from the config sync table of the remote Message VPN.
	LastMsgRxTime *int32 `json:"lastMsgRxTime,omitempty"`
...
func NewMsgVpnConfigSyncRemoteNode() *MsgVpnConfigSyncRemoteNode {
	this := MsgVpnConfigSyncRemoteNode{}
	return &this
}
...
// GetLastMsgRxTime returns the LastMsgRxTime field value if set, zero value otherwise.
func (o *MsgVpnConfigSyncRemoteNode) GetLastMsgRxTime() int32 {
	if o == nil || o.LastMsgRxTime == nil {
		var ret int32
		return ret
	}
	return *o.LastMsgRxTime
}

// GetLastMsgRxTimeOk returns a tuple with the LastMsgRxTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnConfigSyncRemoteNode) GetLastMsgRxTimeOk() (*int32, bool) {
	if o == nil || o.LastMsgRxTime == nil {
		return nil, false
	}
	return o.LastMsgRxTime, true
}
...
// SetLastMsgRxTime gets a reference to the given int32 and assigns it to the LastMsgRxTime field.
...
func (o MsgVpnConfigSyncRemoteNode) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.LastMsgRxTime != nil {
		toSerialize["lastMsgRxTime"] = o.LastMsgRxTime
	}
	if o.MsgVpnName != nil {
...
type NullableMsgVpnConfigSyncRemoteNode struct {
	value *MsgVpnConfigSyncRemoteNode
	isSet bool
}

func (v NullableMsgVpnConfigSyncRemoteNode) Get() *MsgVpnConfigSyncRemoteNode {
	return v.value
}

func (v *NullableMsgVpnConfigSyncRemoteNode) Set(val *MsgVpnConfigSyncRemoteNode) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnConfigSyncRemoteNode) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnConfigSyncRemoteNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnConfigSyncRemoteNode(val *MsgVpnConfigSyncRemoteNode) *NullableMsgVpnConfigSyncRemoteNode {
	return &NullableMsgVpnConfigSyncRemoteNode{value: val, isSet: true}
}

func (v NullableMsgVpnConfigSyncRemoteNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnConfigSyncRemoteNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
