...
// MsgVpnBridgeLocalSubscription struct for MsgVpnBridgeLocalSubscription
type MsgVpnBridgeLocalSubscription struct {
	...
	DtoPriority *string `json:"dtoPriority,omitempty"`
	// The topic of the Bridge local subscription.
	LocalSubscriptionTopic *string `json:"localSubscriptionTopic,omitempty"`
...
func NewMsgVpnBridgeLocalSubscription() *MsgVpnBridgeLocalSubscription {
	this := MsgVpnBridgeLocalSubscription{}
	return &this
}
...
// GetDtoPriority returns the DtoPriority field value if set, zero value otherwise.
func (o *MsgVpnBridgeLocalSubscription) GetDtoPriority() string {
	if o == nil || o.DtoPriority == nil {
		var ret string
		return ret
	}
	return *o.DtoPriority
}

// GetDtoPriorityOk returns a tuple with the DtoPriority field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeLocalSubscription) GetDtoPriorityOk() (*string, bool) {
	if o == nil || o.DtoPriority == nil {
		return nil, false
	}
	return o.DtoPriority, true
}
...
// SetDtoPriority gets a reference to the given string and assigns it to the DtoPriority field.
func (o *MsgVpnBridgeLocalSubscription) SetDtoPriority(v string) {
	o.DtoPriority = &v
}

// GetLocalSubscriptionTopic returns the LocalSubscriptionTopic field value if set, zero value otherwise.
func (o *MsgVpnBridgeLocalSubscription) GetLocalSubscriptionTopic() string {
	if o == nil || o.LocalSubscriptionTopic == nil {
		var ret string
		return ret
	}
	return *o.LocalSubscriptionTopic
}

// GetLocalSubscriptionTopicOk returns a tuple with the LocalSubscriptionTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeLocalSubscription) GetLocalSubscriptionTopicOk() (*string, bool) {
	if o == nil || o.LocalSubscriptionTopic == nil {
		return nil, false
	}
	return o.LocalSubscriptionTopic, true
}
...
// SetLocalSubscriptionTopic gets a reference to the given string and assigns it to the LocalSubscriptionTopic field.
func (o *MsgVpnBridgeLocalSubscription) SetLocalSubscriptionTopic(v string) {
	o.LocalSubscriptionTopic = &v
}
...
func (o MsgVpnBridgeLocalSubscription) MarshalJSON() ([]byte, error) {
	...
	if o.DtoPriority != nil {
		toSerialize["dtoPriority"] = o.DtoPriority
	}
	if o.LocalSubscriptionTopic != nil {
		toSerialize["localSubscriptionTopic"] = o.LocalSubscriptionTopic
	}
	if o.MsgVpnName != nil {
...
type NullableMsgVpnBridgeLocalSubscription struct {
	value *MsgVpnBridgeLocalSubscription
	isSet bool
}

func (v NullableMsgVpnBridgeLocalSubscription) Get() *MsgVpnBridgeLocalSubscription {
	return v.value
}

func (v *NullableMsgVpnBridgeLocalSubscription) Set(val *MsgVpnBridgeLocalSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeLocalSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeLocalSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeLocalSubscription(val *MsgVpnBridgeLocalSubscription) *NullableMsgVpnBridgeLocalSubscription {
	return &NullableMsgVpnBridgeLocalSubscription{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeLocalSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeLocalSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
