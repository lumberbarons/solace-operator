...
// DmrClusterLinkChannelsResponse struct for DmrClusterLinkChannelsResponse
type DmrClusterLinkChannelsResponse struct {
	Collections *[]map[string]interface{}     `json:"collections,omitempty"`
	Data        *[]DmrClusterLinkChannel      `json:"data,omitempty"`
	Links       *[]DmrClusterLinkChannelLinks `json:"links,omitempty"`
...
func NewDmrClusterLinkChannelsResponse(meta SempMeta) *DmrClusterLinkChannelsResponse {
	this := DmrClusterLinkChannelsResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []DmrClusterLinkChannel and assigns it to the Data field.
...
func (o *DmrClusterLinkChannelsResponse) GetLinks() []DmrClusterLinkChannelLinks {
	if o == nil || o.Links == nil {
		var ret []DmrClusterLinkChannelLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []DmrClusterLinkChannelLinks and assigns it to the Links field.
...
func (o DmrClusterLinkChannelsResponse) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterLinkChannelsResponse struct {
	value *DmrClusterLinkChannelsResponse
	isSet bool
}

func (v NullableDmrClusterLinkChannelsResponse) Get() *DmrClusterLinkChannelsResponse {
	return v.value
}

func (v *NullableDmrClusterLinkChannelsResponse) Set(val *DmrClusterLinkChannelsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterLinkChannelsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterLinkChannelsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterLinkChannelsResponse(val *DmrClusterLinkChannelsResponse) *NullableDmrClusterLinkChannelsResponse {
	return &NullableDmrClusterLinkChannelsResponse{value: val, isSet: true}
}

func (v NullableDmrClusterLinkChannelsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterLinkChannelsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
