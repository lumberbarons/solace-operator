...
------------ | ------------- | ------------- | -------------
**AclProfileName** | Pointer to **string** | The ACL Profile of the Client Username. | [optional] 
**ClientProfileName** | Pointer to **string** | The Client Profile of the Client Username. | [optional] 
**ClientUsername** | Pointer to **string** | The name of the Client Username. | [optional] 
**Dynamic** | Pointer to **bool** | Indicates whether the Client Username was dynamically created based on remote authorization data. | [optional] 
**Enabled** | Pointer to **bool** | Indicates whether the Client Username is enabled. | [optional] 
**GuaranteedEndpointPermissionOverrideEnabled** | Pointer to **bool** | Indicates whether the guaranteed endpoint permission override is enabled for the Client Username. | [optional] 
**MsgVpnName** | Pointer to **string** | The name of the Message VPN. | [optional] 
**SubscriptionManagerEnabled** | Pointer to **bool** | Indicates whether the subscription management capability is enabled for the Client Username. | [optional] 
...
`func (o *MsgVpnClientUsername) GetDynamic() bool`

GetDynamic returns the Dynamic field if non-nil, zero value otherwise.

### GetDynamicOk

`func (o *MsgVpnClientUsername) GetDynamicOk() (*bool, bool)`
...
`func (o *MsgVpnClientUsername) SetDynamic(v bool)`

SetDynamic sets Dynamic field to given value.

### HasDynamic

`func (o *MsgVpnClientUsername) HasDynamic() bool`
