...
func main() {
    ...
    resp, r, err := api_client.ReplicatedTopicApi.GetMsgVpnReplicatedTopic(context.Background(), msgVpnName, replicatedTopic).Select_(select_).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ReplicatedTopicApi.GetMsgVpnReplicatedTopics(context.Background(), msgVpnName).Count(count).Cursor(cursor).Where(where).Select_(select_).Execute()
    if err != nil {
