...
**MsgVpnsUri** | Pointer to **string** | The URI of this Broker&#39;s collection of Message VPN objects. Available since 2.11. | [optional] 
**SessionsUri** | Pointer to **string** | The URI of this Broker&#39;s collection of Session objects. Available since 2.21. | [optional] 
**StandardDomainCertAuthoritiesUri** | Pointer to **string** | The URI of this Broker&#39;s collection of Standard Domain Certificate Authority objects. Available since 2.19. | [optional] 
...
GetSessionsUri returns the SessionsUri field if non-nil, zero value otherwise.

### GetSessionsUriOk

`func (o *BrokerLinks) GetSessionsUriOk() (*string, bool)`

GetSessionsUriOk returns a tuple with the SessionsUri field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetSessionsUri sets SessionsUri field to given value.
...
### GetStandardDomainCertAuthoritiesUri

`func (o *BrokerLinks) GetStandardDomainCertAuthoritiesUri() string`

GetStandardDomainCertAuthoritiesUri returns the StandardDomainCertAuthoritiesUri field if non-nil, zero value otherwise.

### GetStandardDomainCertAuthoritiesUriOk

`func (o *BrokerLinks) GetStandardDomainCertAuthoritiesUriOk() (*string, bool)`

GetStandardDomainCertAuthoritiesUriOk returns a tuple with the StandardDomainCertAuthoritiesUri field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetStandardDomainCertAuthoritiesUri

`func (o *BrokerLinks) SetStandardDomainCertAuthoritiesUri(v string)`

SetStandardDomainCertAuthoritiesUri sets StandardDomainCertAuthoritiesUri field to given value.

### HasStandardDomainCertAuthoritiesUri
