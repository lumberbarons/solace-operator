...
// MsgVpnTransactionConsumerMsgResponse struct for MsgVpnTransactionConsumerMsgResponse
type MsgVpnTransactionConsumerMsgResponse struct {
...
func NewMsgVpnTransactionConsumerMsgResponse(meta SempMeta) *MsgVpnTransactionConsumerMsgResponse {
	this := MsgVpnTransactionConsumerMsgResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnTransactionConsumerMsgResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTransactionConsumerMsgResponse struct {
	value *MsgVpnTransactionConsumerMsgResponse
	isSet bool
}

func (v NullableMsgVpnTransactionConsumerMsgResponse) Get() *MsgVpnTransactionConsumerMsgResponse {
	return v.value
}

func (v *NullableMsgVpnTransactionConsumerMsgResponse) Set(val *MsgVpnTransactionConsumerMsgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTransactionConsumerMsgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTransactionConsumerMsgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTransactionConsumerMsgResponse(val *MsgVpnTransactionConsumerMsgResponse) *NullableMsgVpnTransactionConsumerMsgResponse {
	return &NullableMsgVpnTransactionConsumerMsgResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTransactionConsumerMsgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTransactionConsumerMsgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
