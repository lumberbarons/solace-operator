...
// MsgVpnTopicEndpointPriority struct for MsgVpnTopicEndpointPriority
type MsgVpnTopicEndpointPriority struct {
...
func NewMsgVpnTopicEndpointPriority() *MsgVpnTopicEndpointPriority {
	this := MsgVpnTopicEndpointPriority{}
	return &this
}
...
func (o MsgVpnTopicEndpointPriority) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointPriority struct {
	value *MsgVpnTopicEndpointPriority
	isSet bool
}

func (v NullableMsgVpnTopicEndpointPriority) Get() *MsgVpnTopicEndpointPriority {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointPriority) Set(val *MsgVpnTopicEndpointPriority) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointPriority) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointPriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointPriority(val *MsgVpnTopicEndpointPriority) *NullableMsgVpnTopicEndpointPriority {
	return &NullableMsgVpnTopicEndpointPriority{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointPriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointPriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
