...
// MsgVpnTransactionPublisherMsg struct for MsgVpnTransactionPublisherMsg
type MsgVpnTransactionPublisherMsg struct {
...
func NewMsgVpnTransactionPublisherMsg() *MsgVpnTransactionPublisherMsg {
	this := MsgVpnTransactionPublisherMsg{}
	return &this
}
...
func (o MsgVpnTransactionPublisherMsg) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTransactionPublisherMsg struct {
	value *MsgVpnTransactionPublisherMsg
	isSet bool
}

func (v NullableMsgVpnTransactionPublisherMsg) Get() *MsgVpnTransactionPublisherMsg {
	return v.value
}

func (v *NullableMsgVpnTransactionPublisherMsg) Set(val *MsgVpnTransactionPublisherMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTransactionPublisherMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTransactionPublisherMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTransactionPublisherMsg(val *MsgVpnTransactionPublisherMsg) *NullableMsgVpnTransactionPublisherMsg {
	return &NullableMsgVpnTransactionPublisherMsg{value: val, isSet: true}
}

func (v NullableMsgVpnTransactionPublisherMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTransactionPublisherMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
