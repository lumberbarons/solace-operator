...
// MsgVpnReplayLogMsgResponse struct for MsgVpnReplayLogMsgResponse
type MsgVpnReplayLogMsgResponse struct {
...
func NewMsgVpnReplayLogMsgResponse(meta SempMeta) *MsgVpnReplayLogMsgResponse {
	this := MsgVpnReplayLogMsgResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnReplayLogMsgResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnReplayLogMsgResponse struct {
	value *MsgVpnReplayLogMsgResponse
	isSet bool
}

func (v NullableMsgVpnReplayLogMsgResponse) Get() *MsgVpnReplayLogMsgResponse {
	return v.value
}

func (v *NullableMsgVpnReplayLogMsgResponse) Set(val *MsgVpnReplayLogMsgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnReplayLogMsgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnReplayLogMsgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnReplayLogMsgResponse(val *MsgVpnReplayLogMsgResponse) *NullableMsgVpnReplayLogMsgResponse {
	return &NullableMsgVpnReplayLogMsgResponse{value: val, isSet: true}
}

func (v NullableMsgVpnReplayLogMsgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnReplayLogMsgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
