...
/*
ReplayLogApiService Get a Message object.
 ...
 * @param optional nil or *ReplayLogApiGetMsgVpnReplayLogMsgOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnReplayLogMsgResponse
*/

type ReplayLogApiGetMsgVpnReplayLogMsgOpts struct {
	Select_ optional.Interface
}

func (a *ReplayLogApiService) GetMsgVpnReplayLogMsg(ctx context.Context, msgVpnName string, replayLogName string, msgId string, localVarOptionals *ReplayLogApiGetMsgVpnReplayLogMsgOpts) (MsgVpnReplayLogMsgResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ReplayLogApiService Get a list of Message objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param replayLogName The name of the Replay Log.
 * @param optional nil or *ReplayLogApiGetMsgVpnReplayLogMsgsOpts - Optional Parameters:
...
type ReplayLogApiGetMsgVpnReplayLogMsgsOpts struct {
...
func (a *ReplayLogApiService) GetMsgVpnReplayLogMsgs(ctx context.Context, msgVpnName string, replayLogName string, localVarOptionals *ReplayLogApiGetMsgVpnReplayLogMsgsOpts) (MsgVpnReplayLogMsgsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
