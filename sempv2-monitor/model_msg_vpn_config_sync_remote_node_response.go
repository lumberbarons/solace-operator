...
// MsgVpnConfigSyncRemoteNodeResponse struct for MsgVpnConfigSyncRemoteNodeResponse
type MsgVpnConfigSyncRemoteNodeResponse struct {
...
func NewMsgVpnConfigSyncRemoteNodeResponse(meta SempMeta) *MsgVpnConfigSyncRemoteNodeResponse {
	this := MsgVpnConfigSyncRemoteNodeResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnConfigSyncRemoteNodeResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnConfigSyncRemoteNodeResponse struct {
	value *MsgVpnConfigSyncRemoteNodeResponse
	isSet bool
}

func (v NullableMsgVpnConfigSyncRemoteNodeResponse) Get() *MsgVpnConfigSyncRemoteNodeResponse {
	return v.value
}

func (v *NullableMsgVpnConfigSyncRemoteNodeResponse) Set(val *MsgVpnConfigSyncRemoteNodeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnConfigSyncRemoteNodeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnConfigSyncRemoteNodeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnConfigSyncRemoteNodeResponse(val *MsgVpnConfigSyncRemoteNodeResponse) *NullableMsgVpnConfigSyncRemoteNodeResponse {
	return &NullableMsgVpnConfigSyncRemoteNodeResponse{value: val, isSet: true}
}

func (v NullableMsgVpnConfigSyncRemoteNodeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnConfigSyncRemoteNodeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
