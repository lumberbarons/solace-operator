...
// MsgVpnClientTxFlow struct for MsgVpnClientTxFlow
type MsgVpnClientTxFlow struct {
...
func (o MsgVpnClientTxFlow) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientTxFlow struct {
	value *MsgVpnClientTxFlow
	isSet bool
}

func (v NullableMsgVpnClientTxFlow) Get() *MsgVpnClientTxFlow {
	return v.value
}

func (v *NullableMsgVpnClientTxFlow) Set(val *MsgVpnClientTxFlow) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientTxFlow) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientTxFlow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientTxFlow(val *MsgVpnClientTxFlow) *NullableMsgVpnClientTxFlow {
	return &NullableMsgVpnClientTxFlow{value: val, isSet: true}
}

func (v NullableMsgVpnClientTxFlow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientTxFlow) UnmarshalJSON(src []byte) error {
	v.isSet = true
