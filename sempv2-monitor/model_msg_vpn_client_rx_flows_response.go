...
// MsgVpnClientRxFlowsResponse struct for MsgVpnClientRxFlowsResponse
type MsgVpnClientRxFlowsResponse struct {
	Collections *[]map[string]interface{}  `json:"collections,omitempty"`
	Data        *[]MsgVpnClientRxFlow      `json:"data,omitempty"`
	Links       *[]MsgVpnClientRxFlowLinks `json:"links,omitempty"`
...
func NewMsgVpnClientRxFlowsResponse(meta SempMeta) *MsgVpnClientRxFlowsResponse {
	this := MsgVpnClientRxFlowsResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []MsgVpnClientRxFlow and assigns it to the Data field.
...
func (o *MsgVpnClientRxFlowsResponse) GetLinks() []MsgVpnClientRxFlowLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnClientRxFlowLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnClientRxFlowLinks and assigns it to the Links field.
...
func (o MsgVpnClientRxFlowsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientRxFlowsResponse struct {
	value *MsgVpnClientRxFlowsResponse
	isSet bool
}

func (v NullableMsgVpnClientRxFlowsResponse) Get() *MsgVpnClientRxFlowsResponse {
	return v.value
}

func (v *NullableMsgVpnClientRxFlowsResponse) Set(val *MsgVpnClientRxFlowsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientRxFlowsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientRxFlowsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientRxFlowsResponse(val *MsgVpnClientRxFlowsResponse) *NullableMsgVpnClientRxFlowsResponse {
	return &NullableMsgVpnClientRxFlowsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientRxFlowsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientRxFlowsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
