...
// MsgVpnTopicEndpointMsgResponse struct for MsgVpnTopicEndpointMsgResponse
type MsgVpnTopicEndpointMsgResponse struct {
...
func NewMsgVpnTopicEndpointMsgResponse(meta SempMeta) *MsgVpnTopicEndpointMsgResponse {
	this := MsgVpnTopicEndpointMsgResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnTopicEndpointMsgResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointMsgResponse struct {
	value *MsgVpnTopicEndpointMsgResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointMsgResponse) Get() *MsgVpnTopicEndpointMsgResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointMsgResponse) Set(val *MsgVpnTopicEndpointMsgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointMsgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointMsgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointMsgResponse(val *MsgVpnTopicEndpointMsgResponse) *NullableMsgVpnTopicEndpointMsgResponse {
	return &NullableMsgVpnTopicEndpointMsgResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointMsgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointMsgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
