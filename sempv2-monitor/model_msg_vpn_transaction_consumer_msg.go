...
// MsgVpnTransactionConsumerMsg struct for MsgVpnTransactionConsumerMsg
type MsgVpnTransactionConsumerMsg struct {
...
func NewMsgVpnTransactionConsumerMsg() *MsgVpnTransactionConsumerMsg {
	this := MsgVpnTransactionConsumerMsg{}
	return &this
}
...
func (o MsgVpnTransactionConsumerMsg) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTransactionConsumerMsg struct {
	value *MsgVpnTransactionConsumerMsg
	isSet bool
}

func (v NullableMsgVpnTransactionConsumerMsg) Get() *MsgVpnTransactionConsumerMsg {
	return v.value
}

func (v *NullableMsgVpnTransactionConsumerMsg) Set(val *MsgVpnTransactionConsumerMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTransactionConsumerMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTransactionConsumerMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTransactionConsumerMsg(val *MsgVpnTransactionConsumerMsg) *NullableMsgVpnTransactionConsumerMsg {
	return &NullableMsgVpnTransactionConsumerMsg{value: val, isSet: true}
}

func (v NullableMsgVpnTransactionConsumerMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTransactionConsumerMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
