...
// MsgVpnConfigSyncRemoteNodesResponse struct for MsgVpnConfigSyncRemoteNodesResponse
type MsgVpnConfigSyncRemoteNodesResponse struct {
	Collections *[]map[string]interface{}          `json:"collections,omitempty"`
	Data        *[]MsgVpnConfigSyncRemoteNode      `json:"data,omitempty"`
	Links       *[]MsgVpnConfigSyncRemoteNodeLinks `json:"links,omitempty"`
...
func NewMsgVpnConfigSyncRemoteNodesResponse(meta SempMeta) *MsgVpnConfigSyncRemoteNodesResponse {
	this := MsgVpnConfigSyncRemoteNodesResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnConfigSyncRemoteNodesResponse) GetData() []MsgVpnConfigSyncRemoteNode {
	if o == nil || o.Data == nil {
		var ret []MsgVpnConfigSyncRemoteNode
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnConfigSyncRemoteNode and assigns it to the Data field.
...
func (o *MsgVpnConfigSyncRemoteNodesResponse) GetLinks() []MsgVpnConfigSyncRemoteNodeLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnConfigSyncRemoteNodeLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnConfigSyncRemoteNodeLinks and assigns it to the Links field.
...
func (o MsgVpnConfigSyncRemoteNodesResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnConfigSyncRemoteNodesResponse struct {
	value *MsgVpnConfigSyncRemoteNodesResponse
	isSet bool
}

func (v NullableMsgVpnConfigSyncRemoteNodesResponse) Get() *MsgVpnConfigSyncRemoteNodesResponse {
	return v.value
}

func (v *NullableMsgVpnConfigSyncRemoteNodesResponse) Set(val *MsgVpnConfigSyncRemoteNodesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnConfigSyncRemoteNodesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnConfigSyncRemoteNodesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnConfigSyncRemoteNodesResponse(val *MsgVpnConfigSyncRemoteNodesResponse) *NullableMsgVpnConfigSyncRemoteNodesResponse {
	return &NullableMsgVpnConfigSyncRemoteNodesResponse{value: val, isSet: true}
}

func (v NullableMsgVpnConfigSyncRemoteNodesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnConfigSyncRemoteNodesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
