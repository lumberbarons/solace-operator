...
// StandardDomainCertAuthorityResponse struct for StandardDomainCertAuthorityResponse
type StandardDomainCertAuthorityResponse struct {
...
func NewStandardDomainCertAuthorityResponse(meta SempMeta) *StandardDomainCertAuthorityResponse {
	this := StandardDomainCertAuthorityResponse{}
	this.Meta = meta
	return &this
}
...
func (o StandardDomainCertAuthorityResponse) MarshalJSON() ([]byte, error) {
...
type NullableStandardDomainCertAuthorityResponse struct {
	value *StandardDomainCertAuthorityResponse
	isSet bool
}

func (v NullableStandardDomainCertAuthorityResponse) Get() *StandardDomainCertAuthorityResponse {
	return v.value
}

func (v *NullableStandardDomainCertAuthorityResponse) Set(val *StandardDomainCertAuthorityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStandardDomainCertAuthorityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStandardDomainCertAuthorityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStandardDomainCertAuthorityResponse(val *StandardDomainCertAuthorityResponse) *NullableStandardDomainCertAuthorityResponse {
	return &NullableStandardDomainCertAuthorityResponse{value: val, isSet: true}
}

func (v NullableStandardDomainCertAuthorityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStandardDomainCertAuthorityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
