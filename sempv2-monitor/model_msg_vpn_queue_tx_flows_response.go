...
// MsgVpnQueueTxFlowsResponse struct for MsgVpnQueueTxFlowsResponse
type MsgVpnQueueTxFlowsResponse struct {
	Collections *[]map[string]interface{} `json:"collections,omitempty"`
	Data        *[]MsgVpnQueueTxFlow      `json:"data,omitempty"`
	Links       *[]MsgVpnQueueTxFlowLinks `json:"links,omitempty"`
...
func NewMsgVpnQueueTxFlowsResponse(meta SempMeta) *MsgVpnQueueTxFlowsResponse {
	this := MsgVpnQueueTxFlowsResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []MsgVpnQueueTxFlow and assigns it to the Data field.
...
func (o *MsgVpnQueueTxFlowsResponse) GetLinks() []MsgVpnQueueTxFlowLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnQueueTxFlowLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnQueueTxFlowLinks and assigns it to the Links field.
...
func (o MsgVpnQueueTxFlowsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueTxFlowsResponse struct {
	value *MsgVpnQueueTxFlowsResponse
	isSet bool
}

func (v NullableMsgVpnQueueTxFlowsResponse) Get() *MsgVpnQueueTxFlowsResponse {
	return v.value
}

func (v *NullableMsgVpnQueueTxFlowsResponse) Set(val *MsgVpnQueueTxFlowsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueTxFlowsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueTxFlowsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueTxFlowsResponse(val *MsgVpnQueueTxFlowsResponse) *NullableMsgVpnQueueTxFlowsResponse {
	return &NullableMsgVpnQueueTxFlowsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueueTxFlowsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueTxFlowsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
