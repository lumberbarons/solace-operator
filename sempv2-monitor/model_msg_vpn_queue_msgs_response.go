...
// MsgVpnQueueMsgsResponse struct for MsgVpnQueueMsgsResponse
type MsgVpnQueueMsgsResponse struct {
	Collections *[]map[string]interface{} `json:"collections,omitempty"`
	Data        *[]MsgVpnQueueMsg         `json:"data,omitempty"`
	Links       *[]MsgVpnQueueMsgLinks    `json:"links,omitempty"`
...
// SetData gets a reference to the given []MsgVpnQueueMsg and assigns it to the Data field.
...
// SetLinks gets a reference to the given []MsgVpnQueueMsgLinks and assigns it to the Links field.
...
func (o MsgVpnQueueMsgsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueMsgsResponse struct {
	value *MsgVpnQueueMsgsResponse
	isSet bool
}

func (v NullableMsgVpnQueueMsgsResponse) Get() *MsgVpnQueueMsgsResponse {
	return v.value
}

func (v *NullableMsgVpnQueueMsgsResponse) Set(val *MsgVpnQueueMsgsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueMsgsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueMsgsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueMsgsResponse(val *MsgVpnQueueMsgsResponse) *NullableMsgVpnQueueMsgsResponse {
	return &NullableMsgVpnQueueMsgsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueueMsgsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueMsgsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
