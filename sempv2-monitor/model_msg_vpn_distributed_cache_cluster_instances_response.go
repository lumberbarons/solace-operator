...
type MsgVpnDistributedCacheClusterInstancesResponse struct {
	Collections *[]MsgVpnDistributedCacheClusterInstanceCollections `json:"collections,omitempty"`
...
func (o *MsgVpnDistributedCacheClusterInstancesResponse) GetCollections() []MsgVpnDistributedCacheClusterInstanceCollections {
	if o == nil || o.Collections == nil {
		var ret []MsgVpnDistributedCacheClusterInstanceCollections
		return ret
	}
...
// SetCollections gets a reference to the given []MsgVpnDistributedCacheClusterInstanceCollections and assigns it to the Collections field.
