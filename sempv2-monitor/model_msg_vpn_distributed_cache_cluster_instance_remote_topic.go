...
// MsgVpnDistributedCacheClusterInstanceRemoteTopic struct for MsgVpnDistributedCacheClusterInstanceRemoteTopic
type MsgVpnDistributedCacheClusterInstanceRemoteTopic struct {
	// The name of the Distributed Cache.
	CacheName *string `json:"cacheName,omitempty"`
	// The name of the Cache Cluster.
	ClusterName *string `json:"clusterName,omitempty"`
	// Indicates whether the type of the remote Topic is global.
	GlobalTopic *bool `json:"globalTopic,omitempty"`
	...
	MsgCount *int32 `json:"msgCount,omitempty"`
...
func NewMsgVpnDistributedCacheClusterInstanceRemoteTopic() *MsgVpnDistributedCacheClusterInstanceRemoteTopic {
	this := MsgVpnDistributedCacheClusterInstanceRemoteTopic{}
	return &this
}
...
// GetGlobalTopic returns the GlobalTopic field value if set, zero value otherwise.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteTopic) GetGlobalTopic() bool {
	if o == nil || o.GlobalTopic == nil {
		var ret bool
		return ret
	}
	return *o.GlobalTopic
}

// GetGlobalTopicOk returns a tuple with the GlobalTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCacheClusterInstanceRemoteTopic) GetGlobalTopicOk() (*bool, bool) {
	if o == nil || o.GlobalTopic == nil {
		return nil, false
	}
	return o.GlobalTopic, true
}
...
// SetGlobalTopic gets a reference to the given bool and assigns it to the GlobalTopic field.
...
// SetMsgCount gets a reference to the given int32 and assigns it to the MsgCount field.
...
func (o MsgVpnDistributedCacheClusterInstanceRemoteTopic) MarshalJSON() ([]byte, error) {
	...
	if o.GlobalTopic != nil {
		toSerialize["globalTopic"] = o.GlobalTopic
	}
...
type NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic struct {
	value *MsgVpnDistributedCacheClusterInstanceRemoteTopic
	isSet bool
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) Get() *MsgVpnDistributedCacheClusterInstanceRemoteTopic {
	return v.value
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) Set(val *MsgVpnDistributedCacheClusterInstanceRemoteTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCacheClusterInstanceRemoteTopic(val *MsgVpnDistributedCacheClusterInstanceRemoteTopic) *NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic {
	return &NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceRemoteTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
