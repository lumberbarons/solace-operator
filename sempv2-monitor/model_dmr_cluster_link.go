...
// GetRemoteClusterName returns the RemoteClusterName field value if set, zero value otherwise.
func (o *DmrClusterLink) GetRemoteClusterName() string {
	if o == nil || o.RemoteClusterName == nil {
		var ret string
		return ret
	}
	return *o.RemoteClusterName
}

// GetRemoteClusterNameOk returns a tuple with the RemoteClusterName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DmrClusterLink) GetRemoteClusterNameOk() (*string, bool) {
	if o == nil || o.RemoteClusterName == nil {
		return nil, false
	}
	return o.RemoteClusterName, true
}
...
// SetRemoteClusterName gets a reference to the given string and assigns it to the RemoteClusterName field.
func (o *DmrClusterLink) SetRemoteClusterName(v string) {
	o.RemoteClusterName = &v
}
...
func (o DmrClusterLink) MarshalJSON() ([]byte, error) {
	...
	if o.RemoteClusterName != nil {
		toSerialize["remoteClusterName"] = o.RemoteClusterName
	}
