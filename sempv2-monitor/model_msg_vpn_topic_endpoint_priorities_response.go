...
// MsgVpnTopicEndpointPrioritiesResponse struct for MsgVpnTopicEndpointPrioritiesResponse
type MsgVpnTopicEndpointPrioritiesResponse struct {
	Collections *[]map[string]interface{}           `json:"collections,omitempty"`
	Data        *[]MsgVpnTopicEndpointPriority      `json:"data,omitempty"`
	Links       *[]MsgVpnTopicEndpointPriorityLinks `json:"links,omitempty"`
...
func NewMsgVpnTopicEndpointPrioritiesResponse(meta SempMeta) *MsgVpnTopicEndpointPrioritiesResponse {
	this := MsgVpnTopicEndpointPrioritiesResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnTopicEndpointPrioritiesResponse) GetData() []MsgVpnTopicEndpointPriority {
	if o == nil || o.Data == nil {
		var ret []MsgVpnTopicEndpointPriority
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnTopicEndpointPriority and assigns it to the Data field.
...
func (o *MsgVpnTopicEndpointPrioritiesResponse) GetLinks() []MsgVpnTopicEndpointPriorityLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnTopicEndpointPriorityLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnTopicEndpointPriorityLinks and assigns it to the Links field.
...
func (o MsgVpnTopicEndpointPrioritiesResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointPrioritiesResponse struct {
	value *MsgVpnTopicEndpointPrioritiesResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointPrioritiesResponse) Get() *MsgVpnTopicEndpointPrioritiesResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointPrioritiesResponse) Set(val *MsgVpnTopicEndpointPrioritiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointPrioritiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointPrioritiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointPrioritiesResponse(val *MsgVpnTopicEndpointPrioritiesResponse) *NullableMsgVpnTopicEndpointPrioritiesResponse {
	return &NullableMsgVpnTopicEndpointPrioritiesResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointPrioritiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointPrioritiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
