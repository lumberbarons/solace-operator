...
// MsgVpnBridgeLocalSubscriptionsResponse struct for MsgVpnBridgeLocalSubscriptionsResponse
type MsgVpnBridgeLocalSubscriptionsResponse struct {
	Collections *[]map[string]interface{}             `json:"collections,omitempty"`
	Data        *[]MsgVpnBridgeLocalSubscription      `json:"data,omitempty"`
	Links       *[]MsgVpnBridgeLocalSubscriptionLinks `json:"links,omitempty"`
...
func NewMsgVpnBridgeLocalSubscriptionsResponse(meta SempMeta) *MsgVpnBridgeLocalSubscriptionsResponse {
	this := MsgVpnBridgeLocalSubscriptionsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnBridgeLocalSubscriptionsResponse) GetData() []MsgVpnBridgeLocalSubscription {
	if o == nil || o.Data == nil {
		var ret []MsgVpnBridgeLocalSubscription
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnBridgeLocalSubscription and assigns it to the Data field.
...
func (o *MsgVpnBridgeLocalSubscriptionsResponse) GetLinks() []MsgVpnBridgeLocalSubscriptionLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnBridgeLocalSubscriptionLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnBridgeLocalSubscriptionLinks and assigns it to the Links field.
...
func (o MsgVpnBridgeLocalSubscriptionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnBridgeLocalSubscriptionsResponse struct {
	value *MsgVpnBridgeLocalSubscriptionsResponse
	isSet bool
}

func (v NullableMsgVpnBridgeLocalSubscriptionsResponse) Get() *MsgVpnBridgeLocalSubscriptionsResponse {
	return v.value
}

func (v *NullableMsgVpnBridgeLocalSubscriptionsResponse) Set(val *MsgVpnBridgeLocalSubscriptionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeLocalSubscriptionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeLocalSubscriptionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeLocalSubscriptionsResponse(val *MsgVpnBridgeLocalSubscriptionsResponse) *NullableMsgVpnBridgeLocalSubscriptionsResponse {
	return &NullableMsgVpnBridgeLocalSubscriptionsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeLocalSubscriptionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeLocalSubscriptionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
