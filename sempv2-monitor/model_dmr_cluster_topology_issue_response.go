...
// DmrClusterTopologyIssueResponse struct for DmrClusterTopologyIssueResponse
type DmrClusterTopologyIssueResponse struct {
...
func NewDmrClusterTopologyIssueResponse(meta SempMeta) *DmrClusterTopologyIssueResponse {
	this := DmrClusterTopologyIssueResponse{}
	this.Meta = meta
	return &this
}
...
func (o DmrClusterTopologyIssueResponse) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterTopologyIssueResponse struct {
	value *DmrClusterTopologyIssueResponse
	isSet bool
}

func (v NullableDmrClusterTopologyIssueResponse) Get() *DmrClusterTopologyIssueResponse {
	return v.value
}

func (v *NullableDmrClusterTopologyIssueResponse) Set(val *DmrClusterTopologyIssueResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterTopologyIssueResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterTopologyIssueResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterTopologyIssueResponse(val *DmrClusterTopologyIssueResponse) *NullableDmrClusterTopologyIssueResponse {
	return &NullableDmrClusterTopologyIssueResponse{value: val, isSet: true}
}

func (v NullableDmrClusterTopologyIssueResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterTopologyIssueResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
