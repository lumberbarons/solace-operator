...
// MsgVpnClientTransactedSessionsResponse struct for MsgVpnClientTransactedSessionsResponse
type MsgVpnClientTransactedSessionsResponse struct {
	Collections *[]map[string]interface{}             `json:"collections,omitempty"`
	Data        *[]MsgVpnClientTransactedSession      `json:"data,omitempty"`
	Links       *[]MsgVpnClientTransactedSessionLinks `json:"links,omitempty"`
...
func NewMsgVpnClientTransactedSessionsResponse(meta SempMeta) *MsgVpnClientTransactedSessionsResponse {
	this := MsgVpnClientTransactedSessionsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnClientTransactedSessionsResponse) GetData() []MsgVpnClientTransactedSession {
	if o == nil || o.Data == nil {
		var ret []MsgVpnClientTransactedSession
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnClientTransactedSession and assigns it to the Data field.
...
func (o *MsgVpnClientTransactedSessionsResponse) GetLinks() []MsgVpnClientTransactedSessionLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnClientTransactedSessionLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnClientTransactedSessionLinks and assigns it to the Links field.
...
func (o MsgVpnClientTransactedSessionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientTransactedSessionsResponse struct {
	value *MsgVpnClientTransactedSessionsResponse
	isSet bool
}

func (v NullableMsgVpnClientTransactedSessionsResponse) Get() *MsgVpnClientTransactedSessionsResponse {
	return v.value
}

func (v *NullableMsgVpnClientTransactedSessionsResponse) Set(val *MsgVpnClientTransactedSessionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientTransactedSessionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientTransactedSessionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientTransactedSessionsResponse(val *MsgVpnClientTransactedSessionsResponse) *NullableMsgVpnClientTransactedSessionsResponse {
	return &NullableMsgVpnClientTransactedSessionsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientTransactedSessionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientTransactedSessionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
