...
type DmrCluster struct {
	...
	SubscriptionDbBuildPercentage *int64 `json:"subscriptionDbBuildPercentage,omitempty"`
...
// GetSubscriptionDbBuildPercentage returns the SubscriptionDbBuildPercentage field value if set, zero value otherwise.
func (o *DmrCluster) GetSubscriptionDbBuildPercentage() int64 {
	if o == nil || o.SubscriptionDbBuildPercentage == nil {
		var ret int64
		return ret
	}
	return *o.SubscriptionDbBuildPercentage
}

// GetSubscriptionDbBuildPercentageOk returns a tuple with the SubscriptionDbBuildPercentage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DmrCluster) GetSubscriptionDbBuildPercentageOk() (*int64, bool) {
	if o == nil || o.SubscriptionDbBuildPercentage == nil {
		return nil, false
	}
	return o.SubscriptionDbBuildPercentage, true
}
...
// SetSubscriptionDbBuildPercentage gets a reference to the given int64 and assigns it to the SubscriptionDbBuildPercentage field.
func (o *DmrCluster) SetSubscriptionDbBuildPercentage(v int64) {
	o.SubscriptionDbBuildPercentage = &v
}
...
func (o DmrCluster) MarshalJSON() ([]byte, error) {
	...
	if o.SubscriptionDbBuildPercentage != nil {
		toSerialize["subscriptionDbBuildPercentage"] = o.SubscriptionDbBuildPercentage
	}
