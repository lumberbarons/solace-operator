...
// MsgVpnQueuePrioritiesResponse struct for MsgVpnQueuePrioritiesResponse
type MsgVpnQueuePrioritiesResponse struct {
	Collections *[]map[string]interface{}   `json:"collections,omitempty"`
	Data        *[]MsgVpnQueuePriority      `json:"data,omitempty"`
	Links       *[]MsgVpnQueuePriorityLinks `json:"links,omitempty"`
...
func NewMsgVpnQueuePrioritiesResponse(meta SempMeta) *MsgVpnQueuePrioritiesResponse {
	this := MsgVpnQueuePrioritiesResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []MsgVpnQueuePriority and assigns it to the Data field.
...
func (o *MsgVpnQueuePrioritiesResponse) GetLinks() []MsgVpnQueuePriorityLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnQueuePriorityLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnQueuePriorityLinks and assigns it to the Links field.
...
func (o MsgVpnQueuePrioritiesResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueuePrioritiesResponse struct {
	value *MsgVpnQueuePrioritiesResponse
	isSet bool
}

func (v NullableMsgVpnQueuePrioritiesResponse) Get() *MsgVpnQueuePrioritiesResponse {
	return v.value
}

func (v *NullableMsgVpnQueuePrioritiesResponse) Set(val *MsgVpnQueuePrioritiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueuePrioritiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueuePrioritiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueuePrioritiesResponse(val *MsgVpnQueuePrioritiesResponse) *NullableMsgVpnQueuePrioritiesResponse {
	return &NullableMsgVpnQueuePrioritiesResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueuePrioritiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueuePrioritiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
