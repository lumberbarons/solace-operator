...
// DmrClusterLinkChannelResponse struct for DmrClusterLinkChannelResponse
type DmrClusterLinkChannelResponse struct {
...
func NewDmrClusterLinkChannelResponse(meta SempMeta) *DmrClusterLinkChannelResponse {
	this := DmrClusterLinkChannelResponse{}
	this.Meta = meta
	return &this
}
...
func (o DmrClusterLinkChannelResponse) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterLinkChannelResponse struct {
	value *DmrClusterLinkChannelResponse
	isSet bool
}

func (v NullableDmrClusterLinkChannelResponse) Get() *DmrClusterLinkChannelResponse {
	return v.value
}

func (v *NullableDmrClusterLinkChannelResponse) Set(val *DmrClusterLinkChannelResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterLinkChannelResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterLinkChannelResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterLinkChannelResponse(val *DmrClusterLinkChannelResponse) *NullableDmrClusterLinkChannelResponse {
	return &NullableDmrClusterLinkChannelResponse{value: val, isSet: true}
}

func (v NullableDmrClusterLinkChannelResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterLinkChannelResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
