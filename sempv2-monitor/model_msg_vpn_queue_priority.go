...
// MsgVpnQueuePriority struct for MsgVpnQueuePriority
type MsgVpnQueuePriority struct {
...
func (o MsgVpnQueuePriority) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueuePriority struct {
	value *MsgVpnQueuePriority
	isSet bool
}

func (v NullableMsgVpnQueuePriority) Get() *MsgVpnQueuePriority {
	return v.value
}

func (v *NullableMsgVpnQueuePriority) Set(val *MsgVpnQueuePriority) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueuePriority) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueuePriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueuePriority(val *MsgVpnQueuePriority) *NullableMsgVpnQueuePriority {
	return &NullableMsgVpnQueuePriority{value: val, isSet: true}
}

func (v NullableMsgVpnQueuePriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueuePriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
