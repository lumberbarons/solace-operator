...
// MsgVpnTransactionPublisherMsgResponse struct for MsgVpnTransactionPublisherMsgResponse
type MsgVpnTransactionPublisherMsgResponse struct {
...
func NewMsgVpnTransactionPublisherMsgResponse(meta SempMeta) *MsgVpnTransactionPublisherMsgResponse {
	this := MsgVpnTransactionPublisherMsgResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnTransactionPublisherMsgResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTransactionPublisherMsgResponse struct {
	value *MsgVpnTransactionPublisherMsgResponse
	isSet bool
}

func (v NullableMsgVpnTransactionPublisherMsgResponse) Get() *MsgVpnTransactionPublisherMsgResponse {
	return v.value
}

func (v *NullableMsgVpnTransactionPublisherMsgResponse) Set(val *MsgVpnTransactionPublisherMsgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTransactionPublisherMsgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTransactionPublisherMsgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTransactionPublisherMsgResponse(val *MsgVpnTransactionPublisherMsgResponse) *NullableMsgVpnTransactionPublisherMsgResponse {
	return &NullableMsgVpnTransactionPublisherMsgResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTransactionPublisherMsgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTransactionPublisherMsgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
