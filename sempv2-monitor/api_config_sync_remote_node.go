...
/*
ConfigSyncRemoteNodeApiService Get a Config Sync Remote Node object.
 ...
 * @param optional nil or *ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodeOpts - Optional Parameters:
...
type ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodeOpts struct {
	Select_ optional.Interface
}

func (a *ConfigSyncRemoteNodeApiService) GetMsgVpnConfigSyncRemoteNode(ctx context.Context, msgVpnName string, remoteNodeName string, localVarOptionals *ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodeOpts) (MsgVpnConfigSyncRemoteNodeResponse, *http.Response, error) {
	var (
...
/*
ConfigSyncRemoteNodeApiService Get a list of Config Sync Remote Node objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodesOpts - Optional Parameters:
...
type ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodesOpts struct {
...
func (a *ConfigSyncRemoteNodeApiService) GetMsgVpnConfigSyncRemoteNodes(ctx context.Context, msgVpnName string, localVarOptionals *ConfigSyncRemoteNodeApiGetMsgVpnConfigSyncRemoteNodesOpts) (MsgVpnConfigSyncRemoteNodesResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
