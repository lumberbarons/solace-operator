...
/*
BridgeApiService Get a Bridge Local Subscriptions object.
 ...
 * @param optional nil or *BridgeApiGetMsgVpnBridgeLocalSubscriptionOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnBridgeLocalSubscriptionResponse
*/

type BridgeApiGetMsgVpnBridgeLocalSubscriptionOpts struct {
	Select_ optional.Interface
}

func (a *BridgeApiService) GetMsgVpnBridgeLocalSubscription(ctx context.Context, msgVpnName string, bridgeName string, bridgeVirtualRouter string, localSubscriptionTopic string, localVarOptionals *BridgeApiGetMsgVpnBridgeLocalSubscriptionOpts) (MsgVpnBridgeLocalSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
BridgeApiService Get a list of Bridge Local Subscriptions objects.
 ...
 * @param bridgeName The name of the Bridge.
 * @param bridgeVirtualRouter The virtual router of the Bridge.
 * @param optional nil or *BridgeApiGetMsgVpnBridgeLocalSubscriptionsOpts - Optional Parameters:
...
type BridgeApiGetMsgVpnBridgeLocalSubscriptionsOpts struct {
...
func (a *BridgeApiService) GetMsgVpnBridgeLocalSubscriptions(ctx context.Context, msgVpnName string, bridgeName string, bridgeVirtualRouter string, localVarOptionals *BridgeApiGetMsgVpnBridgeLocalSubscriptionsOpts) (MsgVpnBridgeLocalSubscriptionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
