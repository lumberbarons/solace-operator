...
// MsgVpnTopicEndpointMsgsResponse struct for MsgVpnTopicEndpointMsgsResponse
type MsgVpnTopicEndpointMsgsResponse struct {
	Collections *[]map[string]interface{}      `json:"collections,omitempty"`
	Data        *[]MsgVpnTopicEndpointMsg      `json:"data,omitempty"`
	Links       *[]MsgVpnTopicEndpointMsgLinks `json:"links,omitempty"`
...
func NewMsgVpnTopicEndpointMsgsResponse(meta SempMeta) *MsgVpnTopicEndpointMsgsResponse {
	this := MsgVpnTopicEndpointMsgsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnTopicEndpointMsgsResponse) GetData() []MsgVpnTopicEndpointMsg {
	if o == nil || o.Data == nil {
		var ret []MsgVpnTopicEndpointMsg
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnTopicEndpointMsg and assigns it to the Data field.
...
func (o *MsgVpnTopicEndpointMsgsResponse) GetLinks() []MsgVpnTopicEndpointMsgLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnTopicEndpointMsgLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnTopicEndpointMsgLinks and assigns it to the Links field.
...
func (o MsgVpnTopicEndpointMsgsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointMsgsResponse struct {
	value *MsgVpnTopicEndpointMsgsResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointMsgsResponse) Get() *MsgVpnTopicEndpointMsgsResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointMsgsResponse) Set(val *MsgVpnTopicEndpointMsgsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointMsgsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointMsgsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointMsgsResponse(val *MsgVpnTopicEndpointMsgsResponse) *NullableMsgVpnTopicEndpointMsgsResponse {
	return &NullableMsgVpnTopicEndpointMsgsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointMsgsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointMsgsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
