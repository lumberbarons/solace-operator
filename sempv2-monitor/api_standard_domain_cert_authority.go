...
/*
StandardDomainCertAuthorityApiService Get a list of Standard Domain Certificate Authority objects.
 ...
 * @param optional nil or *StandardDomainCertAuthorityApiGetStandardDomainCertAuthoritiesOpts - Optional Parameters:
...
type StandardDomainCertAuthorityApiGetStandardDomainCertAuthoritiesOpts struct {
...
func (a *StandardDomainCertAuthorityApiService) GetStandardDomainCertAuthorities(ctx context.Context, localVarOptionals *StandardDomainCertAuthorityApiGetStandardDomainCertAuthoritiesOpts) (StandardDomainCertAuthoritiesResponse, *http.Response, error) {
	var (
...
/*
StandardDomainCertAuthorityApiService Get a Standard Domain Certificate Authority object.
 ...
 * @param optional nil or *StandardDomainCertAuthorityApiGetStandardDomainCertAuthorityOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return StandardDomainCertAuthorityResponse
*/

type StandardDomainCertAuthorityApiGetStandardDomainCertAuthorityOpts struct {
	Select_ optional.Interface
}

func (a *StandardDomainCertAuthorityApiService) GetStandardDomainCertAuthority(ctx context.Context, certAuthorityName string, localVarOptionals *StandardDomainCertAuthorityApiGetStandardDomainCertAuthorityOpts) (StandardDomainCertAuthorityResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
