...
type MsgVpnRestDeliveryPointResponse struct {
	Collections *MsgVpnRestDeliveryPointCollections `json:"collections,omitempty"`
...
func (o *MsgVpnRestDeliveryPointResponse) GetCollections() MsgVpnRestDeliveryPointCollections {
	if o == nil || o.Collections == nil {
		var ret MsgVpnRestDeliveryPointCollections
		return ret
	}
...
// SetCollections gets a reference to the given MsgVpnRestDeliveryPointCollections and assigns it to the Collections field.
