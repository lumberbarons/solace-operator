...
// MsgVpnReplayLogMsgsResponse struct for MsgVpnReplayLogMsgsResponse
type MsgVpnReplayLogMsgsResponse struct {
	Collections *[]map[string]interface{}  `json:"collections,omitempty"`
	Data        *[]MsgVpnReplayLogMsg      `json:"data,omitempty"`
	Links       *[]MsgVpnReplayLogMsgLinks `json:"links,omitempty"`
...
func NewMsgVpnReplayLogMsgsResponse(meta SempMeta) *MsgVpnReplayLogMsgsResponse {
	this := MsgVpnReplayLogMsgsResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []MsgVpnReplayLogMsg and assigns it to the Data field.
...
func (o *MsgVpnReplayLogMsgsResponse) GetLinks() []MsgVpnReplayLogMsgLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnReplayLogMsgLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnReplayLogMsgLinks and assigns it to the Links field.
...
func (o MsgVpnReplayLogMsgsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnReplayLogMsgsResponse struct {
	value *MsgVpnReplayLogMsgsResponse
	isSet bool
}

func (v NullableMsgVpnReplayLogMsgsResponse) Get() *MsgVpnReplayLogMsgsResponse {
	return v.value
}

func (v *NullableMsgVpnReplayLogMsgsResponse) Set(val *MsgVpnReplayLogMsgsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnReplayLogMsgsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnReplayLogMsgsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnReplayLogMsgsResponse(val *MsgVpnReplayLogMsgsResponse) *NullableMsgVpnReplayLogMsgsResponse {
	return &NullableMsgVpnReplayLogMsgsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnReplayLogMsgsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnReplayLogMsgsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
