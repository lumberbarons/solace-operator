...
// DmrClusterTopologyIssue struct for DmrClusterTopologyIssue
type DmrClusterTopologyIssue struct {
	...
	TopologyIssue *string `json:"topologyIssue,omitempty"`
}
...
// GetTopologyIssue returns the TopologyIssue field value if set, zero value otherwise.
func (o *DmrClusterTopologyIssue) GetTopologyIssue() string {
	if o == nil || o.TopologyIssue == nil {
		var ret string
		return ret
	}
	return *o.TopologyIssue
}

// GetTopologyIssueOk returns a tuple with the TopologyIssue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DmrClusterTopologyIssue) GetTopologyIssueOk() (*string, bool) {
	if o == nil || o.TopologyIssue == nil {
		return nil, false
	}
	return o.TopologyIssue, true
}
...
// SetTopologyIssue gets a reference to the given string and assigns it to the TopologyIssue field.
func (o *DmrClusterTopologyIssue) SetTopologyIssue(v string) {
	o.TopologyIssue = &v
}

func (o DmrClusterTopologyIssue) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.DmrClusterName != nil {
		toSerialize["dmrClusterName"] = o.DmrClusterName
	}
	if o.TopologyIssue != nil {
		toSerialize["topologyIssue"] = o.TopologyIssue
	}
	return json.Marshal(toSerialize)
}

type NullableDmrClusterTopologyIssue struct {
	value *DmrClusterTopologyIssue
	isSet bool
}

func (v NullableDmrClusterTopologyIssue) Get() *DmrClusterTopologyIssue {
	return v.value
}

func (v *NullableDmrClusterTopologyIssue) Set(val *DmrClusterTopologyIssue) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterTopologyIssue) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterTopologyIssue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterTopologyIssue(val *DmrClusterTopologyIssue) *NullableDmrClusterTopologyIssue {
	return &NullableDmrClusterTopologyIssue{value: val, isSet: true}
}

func (v NullableDmrClusterTopologyIssue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterTopologyIssue) UnmarshalJSON(src []byte) error {
	v.isSet = true
