...
// MsgVpnTransactionConsumerMsgsResponse struct for MsgVpnTransactionConsumerMsgsResponse
type MsgVpnTransactionConsumerMsgsResponse struct {
	Collections *[]map[string]interface{}            `json:"collections,omitempty"`
	Data        *[]MsgVpnTransactionConsumerMsg      `json:"data,omitempty"`
	Links       *[]MsgVpnTransactionConsumerMsgLinks `json:"links,omitempty"`
...
func NewMsgVpnTransactionConsumerMsgsResponse(meta SempMeta) *MsgVpnTransactionConsumerMsgsResponse {
	this := MsgVpnTransactionConsumerMsgsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnTransactionConsumerMsgsResponse) GetData() []MsgVpnTransactionConsumerMsg {
	if o == nil || o.Data == nil {
		var ret []MsgVpnTransactionConsumerMsg
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnTransactionConsumerMsg and assigns it to the Data field.
...
func (o *MsgVpnTransactionConsumerMsgsResponse) GetLinks() []MsgVpnTransactionConsumerMsgLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnTransactionConsumerMsgLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnTransactionConsumerMsgLinks and assigns it to the Links field.
...
func (o MsgVpnTransactionConsumerMsgsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTransactionConsumerMsgsResponse struct {
	value *MsgVpnTransactionConsumerMsgsResponse
	isSet bool
}

func (v NullableMsgVpnTransactionConsumerMsgsResponse) Get() *MsgVpnTransactionConsumerMsgsResponse {
	return v.value
}

func (v *NullableMsgVpnTransactionConsumerMsgsResponse) Set(val *MsgVpnTransactionConsumerMsgsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTransactionConsumerMsgsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTransactionConsumerMsgsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTransactionConsumerMsgsResponse(val *MsgVpnTransactionConsumerMsgsResponse) *NullableMsgVpnTransactionConsumerMsgsResponse {
	return &NullableMsgVpnTransactionConsumerMsgsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTransactionConsumerMsgsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTransactionConsumerMsgsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
