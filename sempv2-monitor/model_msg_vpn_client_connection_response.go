...
// MsgVpnClientConnectionResponse struct for MsgVpnClientConnectionResponse
type MsgVpnClientConnectionResponse struct {
...
func NewMsgVpnClientConnectionResponse(meta SempMeta) *MsgVpnClientConnectionResponse {
	this := MsgVpnClientConnectionResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnClientConnectionResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientConnectionResponse struct {
	value *MsgVpnClientConnectionResponse
	isSet bool
}

func (v NullableMsgVpnClientConnectionResponse) Get() *MsgVpnClientConnectionResponse {
	return v.value
}

func (v *NullableMsgVpnClientConnectionResponse) Set(val *MsgVpnClientConnectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientConnectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientConnectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientConnectionResponse(val *MsgVpnClientConnectionResponse) *NullableMsgVpnClientConnectionResponse {
	return &NullableMsgVpnClientConnectionResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientConnectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientConnectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
