...
// MsgVpnQueueMsgResponse struct for MsgVpnQueueMsgResponse
type MsgVpnQueueMsgResponse struct {
...
func (o MsgVpnQueueMsgResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueMsgResponse struct {
	value *MsgVpnQueueMsgResponse
	isSet bool
}

func (v NullableMsgVpnQueueMsgResponse) Get() *MsgVpnQueueMsgResponse {
	return v.value
}

func (v *NullableMsgVpnQueueMsgResponse) Set(val *MsgVpnQueueMsgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueMsgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueMsgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueMsgResponse(val *MsgVpnQueueMsgResponse) *NullableMsgVpnQueueMsgResponse {
	return &NullableMsgVpnQueueMsgResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueueMsgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueMsgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
