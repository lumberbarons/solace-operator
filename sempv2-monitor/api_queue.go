...
/*
QueueApiService Get a Queue Message object.
 ...
 * @param optional nil or *QueueApiGetMsgVpnQueueMsgOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnQueueMsgResponse
*/

type QueueApiGetMsgVpnQueueMsgOpts struct {
	Select_ optional.Interface
}

func (a *QueueApiService) GetMsgVpnQueueMsg(ctx context.Context, msgVpnName string, queueName string, msgId string, localVarOptionals *QueueApiGetMsgVpnQueueMsgOpts) (MsgVpnQueueMsgResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
QueueApiService Get a list of Queue Message objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param queueName The name of the Queue.
 * @param optional nil or *QueueApiGetMsgVpnQueueMsgsOpts - Optional Parameters:
...
type QueueApiGetMsgVpnQueueMsgsOpts struct {
...
func (a *QueueApiService) GetMsgVpnQueueMsgs(ctx context.Context, msgVpnName string, queueName string, localVarOptionals *QueueApiGetMsgVpnQueueMsgsOpts) (MsgVpnQueueMsgsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
QueueApiService Get a list of Queue Priority objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param queueName The name of the Queue.
 * @param optional nil or *QueueApiGetMsgVpnQueuePrioritiesOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type QueueApiGetMsgVpnQueuePrioritiesOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *QueueApiService) GetMsgVpnQueuePriorities(ctx context.Context, msgVpnName string, queueName string, localVarOptionals *QueueApiGetMsgVpnQueuePrioritiesOpts) (MsgVpnQueuePrioritiesResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
QueueApiService Get a Queue Priority object.
 ...
 * @param optional nil or *QueueApiGetMsgVpnQueuePriorityOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnQueuePriorityResponse
*/

type QueueApiGetMsgVpnQueuePriorityOpts struct {
	Select_ optional.Interface
}

func (a *QueueApiService) GetMsgVpnQueuePriority(ctx context.Context, msgVpnName string, queueName string, priority string, localVarOptionals *QueueApiGetMsgVpnQueuePriorityOpts) (MsgVpnQueuePriorityResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
QueueApiService Get a Queue Transmit Flow object.
 ...
 * @param optional nil or *QueueApiGetMsgVpnQueueTxFlowOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnQueueTxFlowResponse
*/

type QueueApiGetMsgVpnQueueTxFlowOpts struct {
	Select_ optional.Interface
}

func (a *QueueApiService) GetMsgVpnQueueTxFlow(ctx context.Context, msgVpnName string, queueName string, flowId string, localVarOptionals *QueueApiGetMsgVpnQueueTxFlowOpts) (MsgVpnQueueTxFlowResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
QueueApiService Get a list of Queue Transmit Flow objects.
Get a list of Queue Transmit Flow objects.  Queue Transmit Flows are used by clients to consume Guaranteed messages from a Queue.   Attribute|Identifying|Deprecated :---|:---:|:---: flowId|x| msgVpnName|x| queueName|x|    A SEMP client authorized with a minimum access scope/level of \&quot;vpn/read-only\&quot; is required to perform this operation.  This has been available since 2.12.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param queueName The name of the Queue.
 * @param optional nil or *QueueApiGetMsgVpnQueueTxFlowsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type QueueApiGetMsgVpnQueueTxFlowsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *QueueApiService) GetMsgVpnQueueTxFlows(ctx context.Context, msgVpnName string, queueName string, localVarOptionals *QueueApiGetMsgVpnQueueTxFlowsOpts) (MsgVpnQueueTxFlowsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
