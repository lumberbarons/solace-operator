...
/*
ClientApiService Get a Client object.
 ...
 * @param optional nil or *ClientApiGetMsgVpnClientOpts - Optional Parameters:
...
type ClientApiGetMsgVpnClientOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClient(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientOpts) (MsgVpnClientResponse, *http.Response, error) {
	var (
...
/*
ClientApiService Get a Client Connection object.
 ...
 * @param optional nil or *ClientApiGetMsgVpnClientConnectionOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnClientConnectionResponse
*/

type ClientApiGetMsgVpnClientConnectionOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClientConnection(ctx context.Context, msgVpnName string, clientName string, clientAddress string, localVarOptionals *ClientApiGetMsgVpnClientConnectionOpts) (MsgVpnClientConnectionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client Connection objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param clientName The name of the Client.
 * @param optional nil or *ClientApiGetMsgVpnClientConnectionsOpts - Optional Parameters:
...
type ClientApiGetMsgVpnClientConnectionsOpts struct {
...
func (a *ClientApiService) GetMsgVpnClientConnections(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientConnectionsOpts) (MsgVpnClientConnectionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a Client Receive Flow object.
 ...
 * @param optional nil or *ClientApiGetMsgVpnClientRxFlowOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnClientRxFlowResponse
*/

type ClientApiGetMsgVpnClientRxFlowOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClientRxFlow(ctx context.Context, msgVpnName string, clientName string, flowId string, localVarOptionals *ClientApiGetMsgVpnClientRxFlowOpts) (MsgVpnClientRxFlowResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client Receive Flow objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param clientName The name of the Client.
 * @param optional nil or *ClientApiGetMsgVpnClientRxFlowsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type ClientApiGetMsgVpnClientRxFlowsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *ClientApiService) GetMsgVpnClientRxFlows(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientRxFlowsOpts) (MsgVpnClientRxFlowsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a Client Subscription object.
 ...
 * @param optional nil or *ClientApiGetMsgVpnClientSubscriptionOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnClientSubscriptionResponse
*/

type ClientApiGetMsgVpnClientSubscriptionOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClientSubscription(ctx context.Context, msgVpnName string, clientName string, subscriptionTopic string, localVarOptionals *ClientApiGetMsgVpnClientSubscriptionOpts) (MsgVpnClientSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client Subscription objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param clientName The name of the Client.
 * @param optional nil or *ClientApiGetMsgVpnClientSubscriptionsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type ClientApiGetMsgVpnClientSubscriptionsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *ClientApiService) GetMsgVpnClientSubscriptions(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientSubscriptionsOpts) (MsgVpnClientSubscriptionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a Client Transacted Session object.
 ...
 * @param optional nil or *ClientApiGetMsgVpnClientTransactedSessionOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnClientTransactedSessionResponse
*/

type ClientApiGetMsgVpnClientTransactedSessionOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClientTransactedSession(ctx context.Context, msgVpnName string, clientName string, sessionName string, localVarOptionals *ClientApiGetMsgVpnClientTransactedSessionOpts) (MsgVpnClientTransactedSessionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client Transacted Session objects.
Get a list of Client Transacted Session objects.  Transacted Sessions enable clients to group multiple message send and/or receive operations together in single, atomic units known as local transactions.   Attribute|Identifying|Deprecated :---|:---:|:---: clientName|x| msgVpnName|x| sessionName|x|    A SEMP client authorized with a minimum access scope/level of \&quot;vpn/read-only\&quot; is required to perform this operation.  This has been available since 2.12.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param clientName The name of the Client.
 * @param optional nil or *ClientApiGetMsgVpnClientTransactedSessionsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type ClientApiGetMsgVpnClientTransactedSessionsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *ClientApiService) GetMsgVpnClientTransactedSessions(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientTransactedSessionsOpts) (MsgVpnClientTransactedSessionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a Client Transmit Flow object.
 ...
 * @param clientName The name of the Client.
 * @param flowId The identifier (ID) of the flow.
 * @param optional nil or *ClientApiGetMsgVpnClientTxFlowOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnClientTxFlowResponse
*/

type ClientApiGetMsgVpnClientTxFlowOpts struct {
	Select_ optional.Interface
}

func (a *ClientApiService) GetMsgVpnClientTxFlow(ctx context.Context, msgVpnName string, clientName string, flowId string, localVarOptionals *ClientApiGetMsgVpnClientTxFlowOpts) (MsgVpnClientTxFlowResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client Transmit Flow objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param clientName The name of the Client.
 * @param optional nil or *ClientApiGetMsgVpnClientTxFlowsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type ClientApiGetMsgVpnClientTxFlowsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *ClientApiService) GetMsgVpnClientTxFlows(ctx context.Context, msgVpnName string, clientName string, localVarOptionals *ClientApiGetMsgVpnClientTxFlowsOpts) (MsgVpnClientTxFlowsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ClientApiService Get a list of Client objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *ClientApiGetMsgVpnClientsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type ClientApiGetMsgVpnClientsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *ClientApiService) GetMsgVpnClients(ctx context.Context, msgVpnName string, localVarOptionals *ClientApiGetMsgVpnClientsOpts) (MsgVpnClientsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
