...
// StandardDomainCertAuthority struct for StandardDomainCertAuthority
type StandardDomainCertAuthority struct {
...
func NewStandardDomainCertAuthority() *StandardDomainCertAuthority {
	this := StandardDomainCertAuthority{}
	return &this
}
...
func (o StandardDomainCertAuthority) MarshalJSON() ([]byte, error) {
...
type NullableStandardDomainCertAuthority struct {
	value *StandardDomainCertAuthority
	isSet bool
}

func (v NullableStandardDomainCertAuthority) Get() *StandardDomainCertAuthority {
	return v.value
}

func (v *NullableStandardDomainCertAuthority) Set(val *StandardDomainCertAuthority) {
	v.value = val
	v.isSet = true
}

func (v NullableStandardDomainCertAuthority) IsSet() bool {
	return v.isSet
}

func (v *NullableStandardDomainCertAuthority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStandardDomainCertAuthority(val *StandardDomainCertAuthority) *NullableStandardDomainCertAuthority {
	return &NullableStandardDomainCertAuthority{value: val, isSet: true}
}

func (v NullableStandardDomainCertAuthority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStandardDomainCertAuthority) UnmarshalJSON(src []byte) error {
	v.isSet = true
