...
// MsgVpnQueuePriorityResponse struct for MsgVpnQueuePriorityResponse
type MsgVpnQueuePriorityResponse struct {
...
func NewMsgVpnQueuePriorityResponse(meta SempMeta) *MsgVpnQueuePriorityResponse {
	this := MsgVpnQueuePriorityResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnQueuePriorityResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueuePriorityResponse struct {
	value *MsgVpnQueuePriorityResponse
	isSet bool
}

func (v NullableMsgVpnQueuePriorityResponse) Get() *MsgVpnQueuePriorityResponse {
	return v.value
}

func (v *NullableMsgVpnQueuePriorityResponse) Set(val *MsgVpnQueuePriorityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueuePriorityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueuePriorityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueuePriorityResponse(val *MsgVpnQueuePriorityResponse) *NullableMsgVpnQueuePriorityResponse {
	return &NullableMsgVpnQueuePriorityResponse{value: val, isSet: true}
}

func (v NullableMsgVpnQueuePriorityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueuePriorityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
