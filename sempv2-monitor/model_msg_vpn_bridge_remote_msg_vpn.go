...
type MsgVpnBridgeRemoteMsgVpn struct {
	...
	LastQueueBindFailureReason *string `json:"lastQueueBindFailureReason,omitempty"`
	...
	QueueBoundUptime *int32 `json:"queueBoundUptime,omitempty"`
...
// GetLastQueueBindFailureReason returns the LastQueueBindFailureReason field value if set, zero value otherwise.
func (o *MsgVpnBridgeRemoteMsgVpn) GetLastQueueBindFailureReason() string {
	if o == nil || o.LastQueueBindFailureReason == nil {
		var ret string
		return ret
	}
	return *o.LastQueueBindFailureReason
}

// GetLastQueueBindFailureReasonOk returns a tuple with the LastQueueBindFailureReason field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeRemoteMsgVpn) GetLastQueueBindFailureReasonOk() (*string, bool) {
	if o == nil || o.LastQueueBindFailureReason == nil {
		return nil, false
	}
	return o.LastQueueBindFailureReason, true
}
...
// SetLastQueueBindFailureReason gets a reference to the given string and assigns it to the LastQueueBindFailureReason field.
func (o *MsgVpnBridgeRemoteMsgVpn) SetLastQueueBindFailureReason(v string) {
	o.LastQueueBindFailureReason = &v
}
...
// GetQueueBoundUptime returns the QueueBoundUptime field value if set, zero value otherwise.
func (o *MsgVpnBridgeRemoteMsgVpn) GetQueueBoundUptime() int32 {
	if o == nil || o.QueueBoundUptime == nil {
		var ret int32
		return ret
	}
	return *o.QueueBoundUptime
}

// GetQueueBoundUptimeOk returns a tuple with the QueueBoundUptime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeRemoteMsgVpn) GetQueueBoundUptimeOk() (*int32, bool) {
	if o == nil || o.QueueBoundUptime == nil {
		return nil, false
	}
	return o.QueueBoundUptime, true
}
...
// SetQueueBoundUptime gets a reference to the given int32 and assigns it to the QueueBoundUptime field.
func (o *MsgVpnBridgeRemoteMsgVpn) SetQueueBoundUptime(v int32) {
	o.QueueBoundUptime = &v
}
...
func (o MsgVpnBridgeRemoteMsgVpn) MarshalJSON() ([]byte, error) {
	...
	if o.LastQueueBindFailureReason != nil {
		toSerialize["lastQueueBindFailureReason"] = o.LastQueueBindFailureReason
	}
	if o.MsgVpnName != nil {
	...
	if o.QueueBoundUptime != nil {
		toSerialize["queueBoundUptime"] = o.QueueBoundUptime
	}
