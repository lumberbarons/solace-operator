...
// MsgVpnClientRxFlowResponse struct for MsgVpnClientRxFlowResponse
type MsgVpnClientRxFlowResponse struct {
...
func NewMsgVpnClientRxFlowResponse(meta SempMeta) *MsgVpnClientRxFlowResponse {
	this := MsgVpnClientRxFlowResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnClientRxFlowResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientRxFlowResponse struct {
	value *MsgVpnClientRxFlowResponse
	isSet bool
}

func (v NullableMsgVpnClientRxFlowResponse) Get() *MsgVpnClientRxFlowResponse {
	return v.value
}

func (v *NullableMsgVpnClientRxFlowResponse) Set(val *MsgVpnClientRxFlowResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientRxFlowResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientRxFlowResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientRxFlowResponse(val *MsgVpnClientRxFlowResponse) *NullableMsgVpnClientRxFlowResponse {
	return &NullableMsgVpnClientRxFlowResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientRxFlowResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientRxFlowResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
