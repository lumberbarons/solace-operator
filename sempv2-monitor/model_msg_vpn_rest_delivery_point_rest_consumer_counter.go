...
// MsgVpnRestDeliveryPointRestConsumerCounter The counters for the REST Consumer. Deprecated since 2.13. All attributes in this object have been moved to the MsgVpnRestDeliveryPointRestConsumer object.
type MsgVpnRestDeliveryPointRestConsumerCounter struct {
...
func NewMsgVpnRestDeliveryPointRestConsumerCounter() *MsgVpnRestDeliveryPointRestConsumerCounter {
	this := MsgVpnRestDeliveryPointRestConsumerCounter{}
	return &this
}
...
func (o MsgVpnRestDeliveryPointRestConsumerCounter) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnRestDeliveryPointRestConsumerCounter struct {
	value *MsgVpnRestDeliveryPointRestConsumerCounter
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerCounter) Get() *MsgVpnRestDeliveryPointRestConsumerCounter {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerCounter) Set(val *MsgVpnRestDeliveryPointRestConsumerCounter) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerCounter) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerCounter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPointRestConsumerCounter(val *MsgVpnRestDeliveryPointRestConsumerCounter) *NullableMsgVpnRestDeliveryPointRestConsumerCounter {
	return &NullableMsgVpnRestDeliveryPointRestConsumerCounter{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerCounter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerCounter) UnmarshalJSON(src []byte) error {
	v.isSet = true
