...
// MsgVpnClientConnectionsResponse struct for MsgVpnClientConnectionsResponse
type MsgVpnClientConnectionsResponse struct {
	Collections *[]map[string]interface{}      `json:"collections,omitempty"`
	Data        *[]MsgVpnClientConnection      `json:"data,omitempty"`
	Links       *[]MsgVpnClientConnectionLinks `json:"links,omitempty"`
...
func NewMsgVpnClientConnectionsResponse(meta SempMeta) *MsgVpnClientConnectionsResponse {
	this := MsgVpnClientConnectionsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnClientConnectionsResponse) GetData() []MsgVpnClientConnection {
	if o == nil || o.Data == nil {
		var ret []MsgVpnClientConnection
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnClientConnection and assigns it to the Data field.
...
func (o *MsgVpnClientConnectionsResponse) GetLinks() []MsgVpnClientConnectionLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnClientConnectionLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnClientConnectionLinks and assigns it to the Links field.
...
func (o MsgVpnClientConnectionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientConnectionsResponse struct {
	value *MsgVpnClientConnectionsResponse
	isSet bool
}

func (v NullableMsgVpnClientConnectionsResponse) Get() *MsgVpnClientConnectionsResponse {
	return v.value
}

func (v *NullableMsgVpnClientConnectionsResponse) Set(val *MsgVpnClientConnectionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientConnectionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientConnectionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientConnectionsResponse(val *MsgVpnClientConnectionsResponse) *NullableMsgVpnClientConnectionsResponse {
	return &NullableMsgVpnClientConnectionsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientConnectionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientConnectionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
