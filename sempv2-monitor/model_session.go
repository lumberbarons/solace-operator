...
type Session struct {
	...
	LastActivityTime *int32 `json:"lastActivityTime,omitempty"`
...
func (o *Session) GetLastActivityTime() int32 {
	if o == nil || o.LastActivityTime == nil {
		var ret int32
		return ret
	}
...
// SetLastActivityTime gets a reference to the given int32 and assigns it to the LastActivityTime field.
...
func (o *Session) GetSessionUsername() string {
	if o == nil || o.SessionUsername == nil {
		var ret string
		return ret
	}
