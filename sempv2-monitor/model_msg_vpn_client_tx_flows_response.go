...
// MsgVpnClientTxFlowsResponse struct for MsgVpnClientTxFlowsResponse
type MsgVpnClientTxFlowsResponse struct {
	Collections *[]map[string]interface{}  `json:"collections,omitempty"`
	Data        *[]MsgVpnClientTxFlow      `json:"data,omitempty"`
	Links       *[]MsgVpnClientTxFlowLinks `json:"links,omitempty"`
...
func NewMsgVpnClientTxFlowsResponse(meta SempMeta) *MsgVpnClientTxFlowsResponse {
	this := MsgVpnClientTxFlowsResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given []MsgVpnClientTxFlow and assigns it to the Data field.
...
func (o *MsgVpnClientTxFlowsResponse) GetLinks() []MsgVpnClientTxFlowLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnClientTxFlowLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnClientTxFlowLinks and assigns it to the Links field.
...
func (o MsgVpnClientTxFlowsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientTxFlowsResponse struct {
	value *MsgVpnClientTxFlowsResponse
	isSet bool
}

func (v NullableMsgVpnClientTxFlowsResponse) Get() *MsgVpnClientTxFlowsResponse {
	return v.value
}

func (v *NullableMsgVpnClientTxFlowsResponse) Set(val *MsgVpnClientTxFlowsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientTxFlowsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientTxFlowsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientTxFlowsResponse(val *MsgVpnClientTxFlowsResponse) *NullableMsgVpnClientTxFlowsResponse {
	return &NullableMsgVpnClientTxFlowsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientTxFlowsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientTxFlowsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
