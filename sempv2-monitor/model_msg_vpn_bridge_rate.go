...
// MsgVpnBridgeRate The rates for the Bridge. Deprecated since 2.13. All attributes in this object have been moved to the MsgVpnBridge object.
type MsgVpnBridgeRate struct {
...
func (o MsgVpnBridgeRate) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnBridgeRate struct {
	value *MsgVpnBridgeRate
	isSet bool
}

func (v NullableMsgVpnBridgeRate) Get() *MsgVpnBridgeRate {
	return v.value
}

func (v *NullableMsgVpnBridgeRate) Set(val *MsgVpnBridgeRate) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeRate) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeRate(val *MsgVpnBridgeRate) *NullableMsgVpnBridgeRate {
	return &NullableMsgVpnBridgeRate{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
