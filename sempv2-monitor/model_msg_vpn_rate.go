...
// MsgVpnRate The rates for the Message VPN. Deprecated since 2.13. All attributes in this object have been moved to the MsgVpn object.
type MsgVpnRate struct {
...
func (o MsgVpnRate) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnRate struct {
	value *MsgVpnRate
	isSet bool
}

func (v NullableMsgVpnRate) Get() *MsgVpnRate {
	return v.value
}

func (v *NullableMsgVpnRate) Set(val *MsgVpnRate) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRate) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRate(val *MsgVpnRate) *NullableMsgVpnRate {
	return &NullableMsgVpnRate{value: val, isSet: true}
}

func (v NullableMsgVpnRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
