...
type MsgVpnRestDeliveryPoint struct {
	...
	TimeConnectionsBlocked *int64 `json:"timeConnectionsBlocked,omitempty"`
...
// GetTimeConnectionsBlocked returns the TimeConnectionsBlocked field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPoint) GetTimeConnectionsBlocked() int64 {
	if o == nil || o.TimeConnectionsBlocked == nil {
		var ret int64
		return ret
	}
	return *o.TimeConnectionsBlocked
}

// GetTimeConnectionsBlockedOk returns a tuple with the TimeConnectionsBlocked field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPoint) GetTimeConnectionsBlockedOk() (*int64, bool) {
	if o == nil || o.TimeConnectionsBlocked == nil {
		return nil, false
	}
	return o.TimeConnectionsBlocked, true
}
...
// SetTimeConnectionsBlocked gets a reference to the given int64 and assigns it to the TimeConnectionsBlocked field.
func (o *MsgVpnRestDeliveryPoint) SetTimeConnectionsBlocked(v int64) {
	o.TimeConnectionsBlocked = &v
}
...
func (o MsgVpnRestDeliveryPoint) MarshalJSON() ([]byte, error) {
	...
	if o.TimeConnectionsBlocked != nil {
		toSerialize["timeConnectionsBlocked"] = o.TimeConnectionsBlocked
	}
	if o.Up != nil {
		toSerialize["up"] = o.Up
	}
