...
// MsgVpnBridgeLocalSubscriptionResponse struct for MsgVpnBridgeLocalSubscriptionResponse
type MsgVpnBridgeLocalSubscriptionResponse struct {
...
func NewMsgVpnBridgeLocalSubscriptionResponse(meta SempMeta) *MsgVpnBridgeLocalSubscriptionResponse {
	this := MsgVpnBridgeLocalSubscriptionResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnBridgeLocalSubscriptionResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnBridgeLocalSubscriptionResponse struct {
	value *MsgVpnBridgeLocalSubscriptionResponse
	isSet bool
}

func (v NullableMsgVpnBridgeLocalSubscriptionResponse) Get() *MsgVpnBridgeLocalSubscriptionResponse {
	return v.value
}

func (v *NullableMsgVpnBridgeLocalSubscriptionResponse) Set(val *MsgVpnBridgeLocalSubscriptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeLocalSubscriptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeLocalSubscriptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeLocalSubscriptionResponse(val *MsgVpnBridgeLocalSubscriptionResponse) *NullableMsgVpnBridgeLocalSubscriptionResponse {
	return &NullableMsgVpnBridgeLocalSubscriptionResponse{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeLocalSubscriptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeLocalSubscriptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
