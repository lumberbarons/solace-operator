...
type BrokerResponse struct {
	Collections *BrokerCollections `json:"collections,omitempty"`
...
// SetCollections gets a reference to the given BrokerCollections and assigns it to the Collections field.
