...
// MsgVpnTopicEndpointTxFlowResponse struct for MsgVpnTopicEndpointTxFlowResponse
type MsgVpnTopicEndpointTxFlowResponse struct {
...
func NewMsgVpnTopicEndpointTxFlowResponse(meta SempMeta) *MsgVpnTopicEndpointTxFlowResponse {
	this := MsgVpnTopicEndpointTxFlowResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnTopicEndpointTxFlowResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointTxFlowResponse struct {
	value *MsgVpnTopicEndpointTxFlowResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointTxFlowResponse) Get() *MsgVpnTopicEndpointTxFlowResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointTxFlowResponse) Set(val *MsgVpnTopicEndpointTxFlowResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointTxFlowResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointTxFlowResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointTxFlowResponse(val *MsgVpnTopicEndpointTxFlowResponse) *NullableMsgVpnTopicEndpointTxFlowResponse {
	return &NullableMsgVpnTopicEndpointTxFlowResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointTxFlowResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointTxFlowResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
