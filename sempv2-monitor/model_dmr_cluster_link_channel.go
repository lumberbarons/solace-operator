...
// DmrClusterLinkChannel struct for DmrClusterLinkChannel
type DmrClusterLinkChannel struct {
	...
	Establisher *bool `json:"establisher,omitempty"`
...
// SetEstablisher gets a reference to the given bool and assigns it to the Establisher field.
...
func (o DmrClusterLinkChannel) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterLinkChannel struct {
	value *DmrClusterLinkChannel
	isSet bool
}

func (v NullableDmrClusterLinkChannel) Get() *DmrClusterLinkChannel {
	return v.value
}

func (v *NullableDmrClusterLinkChannel) Set(val *DmrClusterLinkChannel) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterLinkChannel) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterLinkChannel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterLinkChannel(val *DmrClusterLinkChannel) *NullableDmrClusterLinkChannel {
	return &NullableDmrClusterLinkChannel{value: val, isSet: true}
}

func (v NullableDmrClusterLinkChannel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterLinkChannel) UnmarshalJSON(src []byte) error {
	v.isSet = true
