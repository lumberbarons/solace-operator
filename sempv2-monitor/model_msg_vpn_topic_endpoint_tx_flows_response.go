...
// MsgVpnTopicEndpointTxFlowsResponse struct for MsgVpnTopicEndpointTxFlowsResponse
type MsgVpnTopicEndpointTxFlowsResponse struct {
	Collections *[]map[string]interface{}         `json:"collections,omitempty"`
	Data        *[]MsgVpnTopicEndpointTxFlow      `json:"data,omitempty"`
	Links       *[]MsgVpnTopicEndpointTxFlowLinks `json:"links,omitempty"`
...
func NewMsgVpnTopicEndpointTxFlowsResponse(meta SempMeta) *MsgVpnTopicEndpointTxFlowsResponse {
	this := MsgVpnTopicEndpointTxFlowsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnTopicEndpointTxFlowsResponse) GetData() []MsgVpnTopicEndpointTxFlow {
	if o == nil || o.Data == nil {
		var ret []MsgVpnTopicEndpointTxFlow
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnTopicEndpointTxFlow and assigns it to the Data field.
...
func (o *MsgVpnTopicEndpointTxFlowsResponse) GetLinks() []MsgVpnTopicEndpointTxFlowLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnTopicEndpointTxFlowLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnTopicEndpointTxFlowLinks and assigns it to the Links field.
...
func (o MsgVpnTopicEndpointTxFlowsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnTopicEndpointTxFlowsResponse struct {
	value *MsgVpnTopicEndpointTxFlowsResponse
	isSet bool
}

func (v NullableMsgVpnTopicEndpointTxFlowsResponse) Get() *MsgVpnTopicEndpointTxFlowsResponse {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointTxFlowsResponse) Set(val *MsgVpnTopicEndpointTxFlowsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointTxFlowsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointTxFlowsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointTxFlowsResponse(val *MsgVpnTopicEndpointTxFlowsResponse) *NullableMsgVpnTopicEndpointTxFlowsResponse {
	return &NullableMsgVpnTopicEndpointTxFlowsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointTxFlowsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointTxFlowsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
