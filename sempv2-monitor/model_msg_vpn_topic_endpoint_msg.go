...
// MsgVpnTopicEndpointMsg struct for MsgVpnTopicEndpointMsg
type MsgVpnTopicEndpointMsg struct {
	...
	ReplicatedMateMsgId *int64 `json:"replicatedMateMsgId,omitempty"`
...
// GetRedeliveryCount returns the RedeliveryCount field value if set, zero value otherwise.
func (o *MsgVpnTopicEndpointMsg) GetRedeliveryCount() int32 {
	if o == nil || o.RedeliveryCount == nil {
		var ret int32
		return ret
	}
	return *o.RedeliveryCount
}

// GetRedeliveryCountOk returns a tuple with the RedeliveryCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnTopicEndpointMsg) GetRedeliveryCountOk() (*int32, bool) {
	if o == nil || o.RedeliveryCount == nil {
		return nil, false
	}
	return o.RedeliveryCount, true
}
...
// SetRedeliveryCount gets a reference to the given int32 and assigns it to the RedeliveryCount field.
func (o *MsgVpnTopicEndpointMsg) SetRedeliveryCount(v int32) {
	o.RedeliveryCount = &v
}

// GetReplicatedMateMsgId returns the ReplicatedMateMsgId field value if set, zero value otherwise.
func (o *MsgVpnTopicEndpointMsg) GetReplicatedMateMsgId() int64 {
	if o == nil || o.ReplicatedMateMsgId == nil {
		var ret int64
		return ret
	}
	return *o.ReplicatedMateMsgId
}

// GetReplicatedMateMsgIdOk returns a tuple with the ReplicatedMateMsgId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnTopicEndpointMsg) GetReplicatedMateMsgIdOk() (*int64, bool) {
	if o == nil || o.ReplicatedMateMsgId == nil {
		return nil, false
	}
	return o.ReplicatedMateMsgId, true
}
...
// SetReplicatedMateMsgId gets a reference to the given int64 and assigns it to the ReplicatedMateMsgId field.
func (o *MsgVpnTopicEndpointMsg) SetReplicatedMateMsgId(v int64) {
	o.ReplicatedMateMsgId = &v
}
...
// GetReplicationState returns the ReplicationState field value if set, zero value otherwise.
func (o *MsgVpnTopicEndpointMsg) GetReplicationState() string {
	if o == nil || o.ReplicationState == nil {
		var ret string
		return ret
	}
	return *o.ReplicationState
}

// GetReplicationStateOk returns a tuple with the ReplicationState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnTopicEndpointMsg) GetReplicationStateOk() (*string, bool) {
	if o == nil || o.ReplicationState == nil {
		return nil, false
	}
	return o.ReplicationState, true
}
...
// SetReplicationState gets a reference to the given string and assigns it to the ReplicationState field.
func (o *MsgVpnTopicEndpointMsg) SetReplicationState(v string) {
	o.ReplicationState = &v
}
...
// SetUndelivered gets a reference to the given bool and assigns it to the Undelivered field.
func (o *MsgVpnTopicEndpointMsg) SetUndelivered(v bool) {
	o.Undelivered = &v
}

func (o MsgVpnTopicEndpointMsg) MarshalJSON() ([]byte, error) {
	...
	if o.RedeliveryCount != nil {
		toSerialize["redeliveryCount"] = o.RedeliveryCount
	}
	if o.ReplicatedMateMsgId != nil {
		toSerialize["replicatedMateMsgId"] = o.ReplicatedMateMsgId
	}
	if o.ReplicationGroupMsgId != nil {
		toSerialize["replicationGroupMsgId"] = o.ReplicationGroupMsgId
	}
	if o.ReplicationState != nil {
		toSerialize["replicationState"] = o.ReplicationState
	}
	...
	if o.Undelivered != nil {
		toSerialize["undelivered"] = o.Undelivered
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnTopicEndpointMsg struct {
	value *MsgVpnTopicEndpointMsg
	isSet bool
}

func (v NullableMsgVpnTopicEndpointMsg) Get() *MsgVpnTopicEndpointMsg {
	return v.value
}

func (v *NullableMsgVpnTopicEndpointMsg) Set(val *MsgVpnTopicEndpointMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnTopicEndpointMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnTopicEndpointMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnTopicEndpointMsg(val *MsgVpnTopicEndpointMsg) *NullableMsgVpnTopicEndpointMsg {
	return &NullableMsgVpnTopicEndpointMsg{value: val, isSet: true}
}

func (v NullableMsgVpnTopicEndpointMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnTopicEndpointMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
