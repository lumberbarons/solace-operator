...
// DmrClusterTopologyIssuesResponse struct for DmrClusterTopologyIssuesResponse
type DmrClusterTopologyIssuesResponse struct {
	Collections *[]map[string]interface{}       `json:"collections,omitempty"`
	Data        *[]DmrClusterTopologyIssue      `json:"data,omitempty"`
	Links       *[]DmrClusterTopologyIssueLinks `json:"links,omitempty"`
...
func NewDmrClusterTopologyIssuesResponse(meta SempMeta) *DmrClusterTopologyIssuesResponse {
	this := DmrClusterTopologyIssuesResponse{}
	this.Meta = meta
	return &this
}
...
func (o *DmrClusterTopologyIssuesResponse) GetData() []DmrClusterTopologyIssue {
	if o == nil || o.Data == nil {
		var ret []DmrClusterTopologyIssue
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DmrClusterTopologyIssue and assigns it to the Data field.
...
func (o *DmrClusterTopologyIssuesResponse) GetLinks() []DmrClusterTopologyIssueLinks {
	if o == nil || o.Links == nil {
		var ret []DmrClusterTopologyIssueLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []DmrClusterTopologyIssueLinks and assigns it to the Links field.
...
func (o DmrClusterTopologyIssuesResponse) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterTopologyIssuesResponse struct {
	value *DmrClusterTopologyIssuesResponse
	isSet bool
}

func (v NullableDmrClusterTopologyIssuesResponse) Get() *DmrClusterTopologyIssuesResponse {
	return v.value
}

func (v *NullableDmrClusterTopologyIssuesResponse) Set(val *DmrClusterTopologyIssuesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterTopologyIssuesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterTopologyIssuesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterTopologyIssuesResponse(val *DmrClusterTopologyIssuesResponse) *NullableDmrClusterTopologyIssuesResponse {
	return &NullableDmrClusterTopologyIssuesResponse{value: val, isSet: true}
}

func (v NullableDmrClusterTopologyIssuesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterTopologyIssuesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
