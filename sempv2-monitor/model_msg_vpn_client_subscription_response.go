...
// MsgVpnClientSubscriptionResponse struct for MsgVpnClientSubscriptionResponse
type MsgVpnClientSubscriptionResponse struct {
...
func NewMsgVpnClientSubscriptionResponse(meta SempMeta) *MsgVpnClientSubscriptionResponse {
	this := MsgVpnClientSubscriptionResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnClientSubscriptionResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientSubscriptionResponse struct {
	value *MsgVpnClientSubscriptionResponse
	isSet bool
}

func (v NullableMsgVpnClientSubscriptionResponse) Get() *MsgVpnClientSubscriptionResponse {
	return v.value
}

func (v *NullableMsgVpnClientSubscriptionResponse) Set(val *MsgVpnClientSubscriptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientSubscriptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientSubscriptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientSubscriptionResponse(val *MsgVpnClientSubscriptionResponse) *NullableMsgVpnClientSubscriptionResponse {
	return &NullableMsgVpnClientSubscriptionResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientSubscriptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientSubscriptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
