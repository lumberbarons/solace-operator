...
type MsgVpnLinks struct {
	...
	ClientsUri *string `json:"clientsUri,omitempty"`
	// The URI of this Message VPN's collection of Config Sync Remote Node objects. Available since 2.12.
	ConfigSyncRemoteNodesUri *string `json:"configSyncRemoteNodesUri,omitempty"`
	...
	TransactionsUri *string `json:"transactionsUri,omitempty"`
...
// GetClientsUri returns the ClientsUri field value if set, zero value otherwise.
func (o *MsgVpnLinks) GetClientsUri() string {
	if o == nil || o.ClientsUri == nil {
		var ret string
		return ret
	}
	return *o.ClientsUri
...
// GetClientsUriOk returns a tuple with the ClientsUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnLinks) GetClientsUriOk() (*string, bool) {
	if o == nil || o.ClientsUri == nil {
		return nil, false
	}
	return o.ClientsUri, true
}
...
// SetClientsUri gets a reference to the given string and assigns it to the ClientsUri field.
func (o *MsgVpnLinks) SetClientsUri(v string) {
	o.ClientsUri = &v
}

// GetConfigSyncRemoteNodesUri returns the ConfigSyncRemoteNodesUri field value if set, zero value otherwise.
func (o *MsgVpnLinks) GetConfigSyncRemoteNodesUri() string {
	if o == nil || o.ConfigSyncRemoteNodesUri == nil {
		var ret string
		return ret
	}
	return *o.ConfigSyncRemoteNodesUri
}

// GetConfigSyncRemoteNodesUriOk returns a tuple with the ConfigSyncRemoteNodesUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnLinks) GetConfigSyncRemoteNodesUriOk() (*string, bool) {
	if o == nil || o.ConfigSyncRemoteNodesUri == nil {
		return nil, false
	}
	return o.ConfigSyncRemoteNodesUri, true
}
...
// SetConfigSyncRemoteNodesUri gets a reference to the given string and assigns it to the ConfigSyncRemoteNodesUri field.
func (o *MsgVpnLinks) SetConfigSyncRemoteNodesUri(v string) {
	o.ConfigSyncRemoteNodesUri = &v
}
...
// GetTransactionsUri returns the TransactionsUri field value if set, zero value otherwise.
func (o *MsgVpnLinks) GetTransactionsUri() string {
	if o == nil || o.TransactionsUri == nil {
		var ret string
		return ret
	}
	return *o.TransactionsUri
}

// GetTransactionsUriOk returns a tuple with the TransactionsUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnLinks) GetTransactionsUriOk() (*string, bool) {
	if o == nil || o.TransactionsUri == nil {
		return nil, false
	}
	return o.TransactionsUri, true
}
...
// SetTransactionsUri gets a reference to the given string and assigns it to the TransactionsUri field.
...
func (o MsgVpnLinks) MarshalJSON() ([]byte, error) {
	...
	if o.ClientsUri != nil {
		toSerialize["clientsUri"] = o.ClientsUri
	}
	if o.ConfigSyncRemoteNodesUri != nil {
		toSerialize["configSyncRemoteNodesUri"] = o.ConfigSyncRemoteNodesUri
	}
	...
	if o.TransactionsUri != nil {
		toSerialize["transactionsUri"] = o.TransactionsUri
	}
	if o.Uri != nil {
