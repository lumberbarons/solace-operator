...
type MsgVpnClientProfile struct {
	...
	MaxEffectiveSubscriptionCount *int32 `json:"maxEffectiveSubscriptionCount,omitempty"`
...
// SetMaxEffectiveSubscriptionCount gets a reference to the given int32 and assigns it to the MaxEffectiveSubscriptionCount field.
