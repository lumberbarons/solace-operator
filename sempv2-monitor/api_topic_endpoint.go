...
type TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest) Execute() (MsgVpnTopicEndpointMsgResponse, *_nethttp.Response, error) {
 ...
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsg(ctx _context.Context, msgVpnName string, topicEndpointName string, msgId string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsgExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgRequest) (MsgVpnTopicEndpointMsgResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointMsg")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) Count(count int32) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest {
	r.count = &count
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) Cursor(cursor string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest {
	r.cursor = &cursor
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) Where(where []string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest {
	r.where = &where
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) Execute() (MsgVpnTopicEndpointMsgsResponse, *_nethttp.Response, error) {
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsgs(ctx _context.Context, msgVpnName string, topicEndpointName string) TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsgsExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointMsgsRequest) (MsgVpnTopicEndpointMsgsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointMsgs")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) Count(count int32) TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest {
	r.count = &count
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) Cursor(cursor string) TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest {
	r.cursor = &cursor
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) Where(where []string) TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest {
	r.where = &where
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) Execute() (MsgVpnTopicEndpointPrioritiesResponse, *_nethttp.Response, error) {
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPriorities(ctx _context.Context, msgVpnName string, topicEndpointName string) TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPrioritiesExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointPrioritiesRequest) (MsgVpnTopicEndpointPrioritiesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointPriorities")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest) Execute() (MsgVpnTopicEndpointPriorityResponse, *_nethttp.Response, error) {
 ...
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPriority(ctx _context.Context, msgVpnName string, topicEndpointName string, priority string) TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPriorityExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointPriorityRequest) (MsgVpnTopicEndpointPriorityResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointPriority")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest) Execute() (MsgVpnTopicEndpointTxFlowResponse, *_nethttp.Response, error) {
 ...
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlow(ctx _context.Context, msgVpnName string, topicEndpointName string, flowId string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlowExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowRequest) (MsgVpnTopicEndpointTxFlowResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointTxFlow")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest struct {
	ctx               _context.Context
	ApiService        *TopicEndpointApiService
	msgVpnName        string
	topicEndpointName string
...
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) Count(count int32) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest {
	r.count = &count
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) Cursor(cursor string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest {
	r.cursor = &cursor
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) Where(where []string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest {
	r.where = &where
	return r
}
func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) Select_(select_ []string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest {
	r.select_ = &select_
	return r
}

func (r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) Execute() (MsgVpnTopicEndpointTxFlowsResponse, *_nethttp.Response, error) {
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @return TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest
*/
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlows(ctx _context.Context, msgVpnName string, topicEndpointName string) TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest {
	return TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest{
		ApiService:        a,
		ctx:               ctx,
		msgVpnName:        msgVpnName,
 ...
 */
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlowsExecute(r TopicEndpointApiApiGetMsgVpnTopicEndpointTxFlowsRequest) (MsgVpnTopicEndpointTxFlowsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TopicEndpointApiService.GetMsgVpnTopicEndpointTxFlows")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
