...
/*
TopicEndpointApiService Get a Topic Endpoint Message object.
 ...
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointMsgOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnTopicEndpointMsgResponse
*/

type TopicEndpointApiGetMsgVpnTopicEndpointMsgOpts struct {
	Select_ optional.Interface
}

func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsg(ctx context.Context, msgVpnName string, topicEndpointName string, msgId string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointMsgOpts) (MsgVpnTopicEndpointMsgResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TopicEndpointApiService Get a list of Topic Endpoint Message objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointMsgsOpts - Optional Parameters:
...
type TopicEndpointApiGetMsgVpnTopicEndpointMsgsOpts struct {
...
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointMsgs(ctx context.Context, msgVpnName string, topicEndpointName string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointMsgsOpts) (MsgVpnTopicEndpointMsgsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TopicEndpointApiService Get a list of Topic Endpoint Priority objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointPrioritiesOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type TopicEndpointApiGetMsgVpnTopicEndpointPrioritiesOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPriorities(ctx context.Context, msgVpnName string, topicEndpointName string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointPrioritiesOpts) (MsgVpnTopicEndpointPrioritiesResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TopicEndpointApiService Get a Topic Endpoint Priority object.
 ...
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointPriorityOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnTopicEndpointPriorityResponse
*/

type TopicEndpointApiGetMsgVpnTopicEndpointPriorityOpts struct {
	Select_ optional.Interface
}

func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointPriority(ctx context.Context, msgVpnName string, topicEndpointName string, priority string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointPriorityOpts) (MsgVpnTopicEndpointPriorityResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TopicEndpointApiService Get a Topic Endpoint Transmit Flow object.
 ...
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointTxFlowOpts - Optional Parameters:
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnTopicEndpointTxFlowResponse
*/

type TopicEndpointApiGetMsgVpnTopicEndpointTxFlowOpts struct {
	Select_ optional.Interface
}

func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlow(ctx context.Context, msgVpnName string, topicEndpointName string, flowId string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointTxFlowOpts) (MsgVpnTopicEndpointTxFlowResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
TopicEndpointApiService Get a list of Topic Endpoint Transmit Flow objects.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param topicEndpointName The name of the Topic Endpoint.
 * @param optional nil or *TopicEndpointApiGetMsgVpnTopicEndpointTxFlowsOpts - Optional Parameters:
     * @param "Count" (optional.Int32) -  Limit the count of objects in the response. See the documentation for the &#x60;count&#x60; parameter.
     * @param "Cursor" (optional.String) -  The cursor, or position, for the next page of objects. See the documentation for the &#x60;cursor&#x60; parameter.
     * @param "Where" (optional.Interface of []string) -  Include in the response only objects where certain conditions are true. See the the documentation for the &#x60;where&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
...
type TopicEndpointApiGetMsgVpnTopicEndpointTxFlowsOpts struct {
	Count   optional.Int32
	Cursor  optional.String
	Where   optional.Interface
	Select_ optional.Interface
...
func (a *TopicEndpointApiService) GetMsgVpnTopicEndpointTxFlows(ctx context.Context, msgVpnName string, topicEndpointName string, localVarOptionals *TopicEndpointApiGetMsgVpnTopicEndpointTxFlowsOpts) (MsgVpnTopicEndpointTxFlowsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
