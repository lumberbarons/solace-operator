...
// MsgVpnClientSubscriptionsResponse struct for MsgVpnClientSubscriptionsResponse
type MsgVpnClientSubscriptionsResponse struct {
	Collections *[]map[string]interface{}        `json:"collections,omitempty"`
	Data        *[]MsgVpnClientSubscription      `json:"data,omitempty"`
	Links       *[]MsgVpnClientSubscriptionLinks `json:"links,omitempty"`
...
func NewMsgVpnClientSubscriptionsResponse(meta SempMeta) *MsgVpnClientSubscriptionsResponse {
	this := MsgVpnClientSubscriptionsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnClientSubscriptionsResponse) GetData() []MsgVpnClientSubscription {
	if o == nil || o.Data == nil {
		var ret []MsgVpnClientSubscription
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []MsgVpnClientSubscription and assigns it to the Data field.
...
func (o *MsgVpnClientSubscriptionsResponse) GetLinks() []MsgVpnClientSubscriptionLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnClientSubscriptionLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnClientSubscriptionLinks and assigns it to the Links field.
...
func (o MsgVpnClientSubscriptionsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnClientSubscriptionsResponse struct {
	value *MsgVpnClientSubscriptionsResponse
	isSet bool
}

func (v NullableMsgVpnClientSubscriptionsResponse) Get() *MsgVpnClientSubscriptionsResponse {
	return v.value
}

func (v *NullableMsgVpnClientSubscriptionsResponse) Set(val *MsgVpnClientSubscriptionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientSubscriptionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientSubscriptionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientSubscriptionsResponse(val *MsgVpnClientSubscriptionsResponse) *NullableMsgVpnClientSubscriptionsResponse {
	return &NullableMsgVpnClientSubscriptionsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnClientSubscriptionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientSubscriptionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
