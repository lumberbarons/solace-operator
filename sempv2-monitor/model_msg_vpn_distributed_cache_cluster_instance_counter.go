...
// MsgVpnDistributedCacheClusterInstanceCounter The counters associated with the Cache Instance. Deprecated since 2.13. All attributes in this object have been moved to the MsgVpnDistributedCacheClusterInstance object.
type MsgVpnDistributedCacheClusterInstanceCounter struct {
...
func NewMsgVpnDistributedCacheClusterInstanceCounter() *MsgVpnDistributedCacheClusterInstanceCounter {
	this := MsgVpnDistributedCacheClusterInstanceCounter{}
	return &this
}
...
func (o MsgVpnDistributedCacheClusterInstanceCounter) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnDistributedCacheClusterInstanceCounter struct {
	value *MsgVpnDistributedCacheClusterInstanceCounter
	isSet bool
}

func (v NullableMsgVpnDistributedCacheClusterInstanceCounter) Get() *MsgVpnDistributedCacheClusterInstanceCounter {
	return v.value
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceCounter) Set(val *MsgVpnDistributedCacheClusterInstanceCounter) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCacheClusterInstanceCounter) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceCounter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCacheClusterInstanceCounter(val *MsgVpnDistributedCacheClusterInstanceCounter) *NullableMsgVpnDistributedCacheClusterInstanceCounter {
	return &NullableMsgVpnDistributedCacheClusterInstanceCounter{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCacheClusterInstanceCounter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCacheClusterInstanceCounter) UnmarshalJSON(src []byte) error {
	v.isSet = true
