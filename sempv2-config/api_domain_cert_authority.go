...
/*
DomainCertAuthorityApiService Create a Domain Certificate Authority object.
 ...
 * @param optional nil or *DomainCertAuthorityApiCreateDomainCertAuthorityOpts - Optional Parameters:
...
type DomainCertAuthorityApiCreateDomainCertAuthorityOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DomainCertAuthorityApiService) CreateDomainCertAuthority(ctx context.Context, body DomainCertAuthority, localVarOptionals *DomainCertAuthorityApiCreateDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
...
/*
DomainCertAuthorityApiService Delete a Domain Certificate Authority object.
...
*/
func (a *DomainCertAuthorityApiService) DeleteDomainCertAuthority(ctx context.Context, certAuthorityName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
DomainCertAuthorityApiService Get a list of Domain Certificate Authority objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DomainCertAuthorityApiGetDomainCertAuthoritiesOpts - Optional Parameters:
...
type DomainCertAuthorityApiGetDomainCertAuthoritiesOpts struct {
...
func (a *DomainCertAuthorityApiService) GetDomainCertAuthorities(ctx context.Context, localVarOptionals *DomainCertAuthorityApiGetDomainCertAuthoritiesOpts) (DomainCertAuthoritiesResponse, *http.Response, error) {
	var (
...
/*
DomainCertAuthorityApiService Get a Domain Certificate Authority object.
Get a Domain Certificate Authority object.  Certificate Authorities trusted for domain verification.   Attribute|Identifying|Write-Only|Deprecated|Opaque :---|:---:|:---:|:---:|:---: certAuthorityName|x|||    A SEMP client authorized with a minimum access scope/level of \&quot;global/read-only\&quot; is required to perform this operation.  This has been available since 2.19.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param certAuthorityName The name of the Certificate Authority.
 * @param optional nil or *DomainCertAuthorityApiGetDomainCertAuthorityOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return DomainCertAuthorityResponse
*/

type DomainCertAuthorityApiGetDomainCertAuthorityOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DomainCertAuthorityApiService) GetDomainCertAuthority(ctx context.Context, certAuthorityName string, localVarOptionals *DomainCertAuthorityApiGetDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
DomainCertAuthorityApiService Replace a Domain Certificate Authority object.
 ...
 * @param body The Domain Certificate Authority object&#x27;s attributes.
 * @param certAuthorityName The name of the Certificate Authority.
 * @param optional nil or *DomainCertAuthorityApiReplaceDomainCertAuthorityOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return DomainCertAuthorityResponse
*/

type DomainCertAuthorityApiReplaceDomainCertAuthorityOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DomainCertAuthorityApiService) ReplaceDomainCertAuthority(ctx context.Context, body DomainCertAuthority, certAuthorityName string, localVarOptionals *DomainCertAuthorityApiReplaceDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
...
/*
DomainCertAuthorityApiService Update a Domain Certificate Authority object.
 ...
 * @param body The Domain Certificate Authority object&#x27;s attributes.
 * @param certAuthorityName The name of the Certificate Authority.
 * @param optional nil or *DomainCertAuthorityApiUpdateDomainCertAuthorityOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return DomainCertAuthorityResponse
*/

type DomainCertAuthorityApiUpdateDomainCertAuthorityOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DomainCertAuthorityApiService) UpdateDomainCertAuthority(ctx context.Context, body DomainCertAuthority, certAuthorityName string, localVarOptionals *DomainCertAuthorityApiUpdateDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
