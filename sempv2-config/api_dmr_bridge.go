...
/*
DmrBridgeApiService Create a DMR Bridge object.
 ...
 * @param optional nil or *DmrBridgeApiCreateMsgVpnDmrBridgeOpts - Optional Parameters:
...
type DmrBridgeApiCreateMsgVpnDmrBridgeOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DmrBridgeApiService) CreateMsgVpnDmrBridge(ctx context.Context, body MsgVpnDmrBridge, msgVpnName string, localVarOptionals *DmrBridgeApiCreateMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
...
/*
DmrBridgeApiService Delete a DMR Bridge object.
...
*/
func (a *DmrBridgeApiService) DeleteMsgVpnDmrBridge(ctx context.Context, msgVpnName string, remoteNodeName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
DmrBridgeApiService Get a DMR Bridge object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param remoteNodeName The name of the node at the remote end of the DMR Bridge.
 * @param optional nil or *DmrBridgeApiGetMsgVpnDmrBridgeOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnDmrBridgeResponse
*/

type DmrBridgeApiGetMsgVpnDmrBridgeOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DmrBridgeApiService) GetMsgVpnDmrBridge(ctx context.Context, msgVpnName string, remoteNodeName string, localVarOptionals *DmrBridgeApiGetMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
...
/*
DmrBridgeApiService Get a list of DMR Bridge objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *DmrBridgeApiGetMsgVpnDmrBridgesOpts - Optional Parameters:
...
type DmrBridgeApiGetMsgVpnDmrBridgesOpts struct {
...
func (a *DmrBridgeApiService) GetMsgVpnDmrBridges(ctx context.Context, msgVpnName string, localVarOptionals *DmrBridgeApiGetMsgVpnDmrBridgesOpts) (MsgVpnDmrBridgesResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
DmrBridgeApiService Replace a DMR Bridge object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param remoteNodeName The name of the node at the remote end of the DMR Bridge.
 * @param optional nil or *DmrBridgeApiReplaceMsgVpnDmrBridgeOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnDmrBridgeResponse
*/

type DmrBridgeApiReplaceMsgVpnDmrBridgeOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DmrBridgeApiService) ReplaceMsgVpnDmrBridge(ctx context.Context, body MsgVpnDmrBridge, msgVpnName string, remoteNodeName string, localVarOptionals *DmrBridgeApiReplaceMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
...
/*
DmrBridgeApiService Update a DMR Bridge object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param remoteNodeName The name of the node at the remote end of the DMR Bridge.
 * @param optional nil or *DmrBridgeApiUpdateMsgVpnDmrBridgeOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnDmrBridgeResponse
*/

type DmrBridgeApiUpdateMsgVpnDmrBridgeOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *DmrBridgeApiService) UpdateMsgVpnDmrBridge(ctx context.Context, body MsgVpnDmrBridge, msgVpnName string, remoteNodeName string, localVarOptionals *DmrBridgeApiUpdateMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
