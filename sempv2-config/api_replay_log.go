...
/*
ReplayLogApiService Create a Replay Log object.
 ...
 * @param optional nil or *ReplayLogApiCreateMsgVpnReplayLogOpts - Optional Parameters:
...
type ReplayLogApiCreateMsgVpnReplayLogOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *ReplayLogApiService) CreateMsgVpnReplayLog(ctx context.Context, body MsgVpnReplayLog, msgVpnName string, localVarOptionals *ReplayLogApiCreateMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
...
/*
ReplayLogApiService Delete a Replay Log object.
...
*/
func (a *ReplayLogApiService) DeleteMsgVpnReplayLog(ctx context.Context, msgVpnName string, replayLogName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
ReplayLogApiService Get a Replay Log object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param replayLogName The name of the Replay Log.
 * @param optional nil or *ReplayLogApiGetMsgVpnReplayLogOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnReplayLogResponse
*/

type ReplayLogApiGetMsgVpnReplayLogOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *ReplayLogApiService) GetMsgVpnReplayLog(ctx context.Context, msgVpnName string, replayLogName string, localVarOptionals *ReplayLogApiGetMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
...
/*
ReplayLogApiService Get a list of Replay Log objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *ReplayLogApiGetMsgVpnReplayLogsOpts - Optional Parameters:
...
type ReplayLogApiGetMsgVpnReplayLogsOpts struct {
...
func (a *ReplayLogApiService) GetMsgVpnReplayLogs(ctx context.Context, msgVpnName string, localVarOptionals *ReplayLogApiGetMsgVpnReplayLogsOpts) (MsgVpnReplayLogsResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ReplayLogApiService Replace a Replay Log object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param replayLogName The name of the Replay Log.
 * @param optional nil or *ReplayLogApiReplaceMsgVpnReplayLogOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnReplayLogResponse
*/

type ReplayLogApiReplaceMsgVpnReplayLogOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *ReplayLogApiService) ReplaceMsgVpnReplayLog(ctx context.Context, body MsgVpnReplayLog, msgVpnName string, replayLogName string, localVarOptionals *ReplayLogApiReplaceMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
...
/*
ReplayLogApiService Update a Replay Log object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param replayLogName The name of the Replay Log.
 * @param optional nil or *ReplayLogApiUpdateMsgVpnReplayLogOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See that documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnReplayLogResponse
*/

type ReplayLogApiUpdateMsgVpnReplayLogOpts struct {
	OpaquePassword optional.String
	Select_        optional.Interface
}

func (a *ReplayLogApiService) UpdateMsgVpnReplayLog(ctx context.Context, body MsgVpnReplayLog, msgVpnName string, replayLogName string, localVarOptionals *ReplayLogApiUpdateMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
